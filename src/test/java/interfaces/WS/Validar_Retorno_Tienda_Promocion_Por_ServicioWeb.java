...
public class Validar_Retorno_Tienda_Promocion_Por_ServicioWeb extends BaseExecution {

	@Test(dataProvider = "data-provider")

	public void ATC_FT_WS_010_Validar_Retorno_Tienda_Promocion_Por_ServicioWeb(HashMap<String, String> data) throws Exception {
		...
		String contra = "http://" + user + ":" + ps + "@" + server
				+ ":5555/invoke/oxxows.pub:wsGetTiendasConvenioPromocion?needDetails=true&groupKey=TODAS";
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return " Validar el retorno de tiendas convenio promoción por parte del servicio web. ";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_WS_010_Validar_Retorno_Tienda_Promocion_Por_ServicioWeb";
	}
