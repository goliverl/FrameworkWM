...
public class Validar_Retorno_GL_Journal_ServicioWeb extends BaseExecution {

	@Test(dataProvider = "data-provider")

	public void ATC_FT_WS_004_Validar_Retorno_GL_Journal_ServicioWeb(HashMap<String, String> data) throws Exception {
		...
		String tdcQRY1 = " SELECT wmuser.wm_gl_journal_s.NEXTVAL FROM dual;\r\n";
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return " Validar el retorno del GL Journal por parte del serv. web. ";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_WS_004_Validar_Retorno_GL_Journal_ServicioWeb";
	}
