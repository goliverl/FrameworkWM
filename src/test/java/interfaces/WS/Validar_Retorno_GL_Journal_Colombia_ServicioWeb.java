...
public class Validar_Retorno_GL_Journal_Colombia_ServicioWeb extends BaseExecution {

	@Test(dataProvider = "data-provider")

	public void ATC_FT_WS_003_Validar_Retorno_GL_Journal_Colombia_ServicioWeb(HashMap<String, String> data) throws Exception {
		...
		String tdcQRY1 = " SSELECT wm_gl_journal_id_col_s.NEXTVAL FROM dual";
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return " Validar el retorno del GL Journal de Colombia por parte del serv. web ";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_WS_003_Validar_Retorno_GL_Journal_Colombia_ServicioWeb";
	}
