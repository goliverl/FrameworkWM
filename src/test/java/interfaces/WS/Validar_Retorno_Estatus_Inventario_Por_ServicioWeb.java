...
public class Validar_Retorno_Estatus_Inventario_Por_ServicioWeb extends BaseExecution {

	@Test(dataProvider = "data-provider")

	public void ATC_FT_WS_002_Validar_Retorno_Estatus_Inventario_Por_ServicioWeb(HashMap<String, String> data) throws Exception {
		...
		String contra = "http://" + user + ":" + ps + "@" + server
				+ ":5555/invoke/oxxows.pub:wsGetSIStatus?propertyNum=[num_doc]&docId=[doc_id]\r\n";
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return " Validar el retorno del estatus de inventario por parte del servicio web. ";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_WS_002_Validar_Retorno_Estatus_Inventario_Por_ServicioWeb";
	}
