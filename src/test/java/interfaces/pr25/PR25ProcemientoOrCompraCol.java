...
public class PR25ProcemientoOrCompraCol extends BaseExecution {
	...
	public void ATC_FT_PR25_003_Procemiento_Or_Compra_Col(HashMap<String, String> data) throws Exception {
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
		...
		String statusThread = regPlazaTiendaRes.getData(0, "STATUS");
		String thread_id = regPlazaTiendaRes.getData(0, "THREAD_ID");
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PR25_003_Procemiento_Or_Compra_Col";
	}
