...
public class ATC_FT_001_PIC01_VerificarCorrectaEjecucion extends BaseExecution {
	...
	public void ATC_FT_001_PIC01_VerificarCorrectaEjecucion_test(HashMap<String, String> data) throws Exception {
...
/** UTILERIA *********************************************************************/
	...
	//	utils.sql.SQLUtil dbEbs = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_EBS, GlobalVariables.DB_USER_EBS, GlobalVariables.DB_PASSWORD_EBS);
		...
		/**
		 * ALM
		 * Verificar la correcta ejecucion para la Plaza 10GUD y Tienda 50KLR
		 * Verificar la correcta ejecución para la Plaza 10MEX y Tienda 50JGY
		 * Verificar la correcta ejecución para la Plaza 10MON y Tienda 50QBK
		 * Verificar la correcta ejecución para la Plaza 10PBI yTienda 50UFD
		 * Verificar la correcta ejecución para la Plaza 10ZAI y Tienda 50SOP
		 */
...
/** VARIABLES *********************************************************************/
		...
		//paso 3
				...
				String validarRPY1 = "SELECT *  FROM DR_DIAS_ENTREGA \r\n"
						+ "WHERE DR_CR_PLAZA = '" + data.get("plaza") + "'\r\n"
						+ "AND DR_CR_TIENDA = '" + data.get("tienda") + "'\r\n"
						+ "AND DR_FECHA_REGISTRO = '" + data.get("fecha_ejecucion") + "'\r\n";
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
		...
		/* PASO 1 *********************************************************************/	
				...
				addStep("Invocar el servicio PIC01.Pub:run mediante la ejecuci�n del JOB runPIC01\r\n");
        ...
        /* PASO 3 *********************************************************************/
                  addStep("Validar que existan registros actualizdos en WM_CONTROL_COPIA con la fecha de la ejecuci�n y el Id de ejecucion.");
                  // Primer consulta
