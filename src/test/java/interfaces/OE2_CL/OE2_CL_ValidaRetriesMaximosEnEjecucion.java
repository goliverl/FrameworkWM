...
public class OE2_CL_ValidaRetriesMaximosEnEjecucion extends BaseExecution {
	@Test(dataProvider = "data-provider")
	public void ATC_FT_006_OE2_CL_ValidaRetriesMaximosEnEjecucion(HashMap<String, String> data) throws Exception {
		/*
	...
	//Paso 6
		 ...
		 * Paso 2
		 ***************************************************************************************************************************/
		addStep("Comprobar que existan registros validos para ser procesados por la interfaz, sin tomar en cuenta los retries, con la siguienta consulta:(Los campos se obtienen de la consulta anterior)");
		
		String registrosPorProcesar_f = String.format(registrosPorProcesar, VALOR5);
...
//  Paso 6  *********************************
		...
		//Primera parte
				String actualizacionFactura1_F = String.format(actualizacionFactura1, ID_FACTURA_DIGITAL, VALOR5);
			...
			//Segunda parte
		        ...
		        String actualizacionFactura2_F = String.format(actualizacionFactura2, ID_FACTURA_DIGITAL, VALOR5);
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_006_OE2_CL_ValidaRetriesMaximosEnEjecucion";
	}

	@Override	public String setTestInstanceID() {
		// TODO Auto-generated method stub
		return null;
	}
