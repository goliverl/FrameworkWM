...
public class OE2_CL_ValidaErrorEnDatosDeEntrada extends BaseExecution {
	@Test(dataProvider = "data-provider")
	public void ATC_FT_003_OE2_CL_ValidaErrorEnDatosDeEntrada(HashMap<String, String> data) throws Exception {
		/*
		...
		//Paso 2 
		String registrosPorProcesar = "SELECT ID_FACTURA_DIGITAL, WM_RETRIES,WM_ESTADO_RESP, WM_ESTATUS,CREATION_DATE\r\n" + 
...
//  Paso 6  *********************************
		...
		addStep("Verificar que en la tabla XXFC_FACTURA_DIGITAL hayan cambiado los siguientes campos.\r\n" + 
				"FOLIO\r\n" + 
				"WM_FECHA\r\n" + 
				"WM_STATUS DEBE ESTAR EN S\r\n" + 
				"WM_ESTADO_RESP DEBE SER DIF DE 0\r\n" + 
				"WM_ESTADO_DOC\r\n" + 
				"WM_ESTADO_ACEP\r\n" + 
				"WM_TRACK_ID\r\n" + 
				"WM_ESTATUS_CODE\r\n" + 
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_003_OE2_CL_ValidaErrorEnDatosDeEntrada";
	}
