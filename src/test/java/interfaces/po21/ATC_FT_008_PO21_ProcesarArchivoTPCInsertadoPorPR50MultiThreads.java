...
public class ATC_FT_008_PO21_ProcesarArchivoTPCInsertadoPorPR50MultiThreads extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_008_PO21_ProcesarArchivoTPCInsertadoPorPR50MultiThreads_test(HashMap<String, String> data) throws Exception {
...
//Paso 15
		String validarStatusS = "SELECT RUN_ID,INTERFACE,START_DT,END_DT,STATUS FROM("
				...
				+ "  FROM WMLOG.WM_LOG_RUN WHERE INTERFACE LIKE '%PO21_OLD%' "
...
//***************************************** Paso 10  *****************************************************************
		...
		addStep("Validar que se actualizó el estatus de los archivos procesados de I a E:");
		System.out.println("Paso 10: "+GlobalVariables.DB_HOST_FCWMQA_NUEVA);
		System.out.println(validarStatusE);
				
		SQLResult exe_validarStatusE = executeQuery(dbFCWM6QA_NUEVA, validarStatusE);
...
//***************************************** Paso 14 y 15 *****************************************************************
		...
		System.out.println("Paso 14 Y 15: "+GlobalVariables.DB_HOST_FCWMLQA);
...
//***************************************** Paso 16 *****************************************************************	
		...
		System.out.println("Paso 16 "+GlobalVariables.DB_HOST_FCWMLQA);
...
//***************************************** Paso 17 *****************************************************************	
		addStep("Ejecutar la siguiente consulta en la BD 'FCWMLQA'");
		System.out.println("Paso 17 "+GlobalVariables.DB_HOST_FCWMLQA);
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Validar que se genere un thread por cada plaza al procesar con la PO21_OLD archivos insertados por la PR50";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_008_PO21_ProcesarArchivoTPCInsertadoPorPR50MultiThreads_test";
	}
