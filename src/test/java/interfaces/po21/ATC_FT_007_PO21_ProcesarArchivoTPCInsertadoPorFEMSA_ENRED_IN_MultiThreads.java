...
public class ATC_FT_007_PO21_ProcesarArchivoTPCInsertadoPorFEMSA_ENRED_IN_MultiThreads extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_007_PO21_ProcesarArchivoTPCInsertadoPorFEMSA_ENRED_IN_MultiThreads_test(HashMap<String, String> data) throws Exception {
...
//***************************************** Paso 8 *****************************************************************
		...
		addStep("Validar que no se haya registrados errores relacionados con la ejecución");
...
//***************************************** Paso 12 *****************************************************************	
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Validar que se genere un thread por cada plaza al procesar con la PO21 archivos insertados por la ENRED_IN";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_007_PO21_ProcesarArchivoTPCInsertadoPorFEMSA_ENRED_IN_MultiThreads_test";
	}
