...
public class ATC_FT_006_Pb10_Verificar_Aumente_Numero_Falla_Ejecuccion_RunLoad extends BaseExecution {	
	
	/*
	 * 
	 * @cp Verificar que aumente el numero de intentos cuando Falla la ejecucion (runLoad)
	 * 
	 */
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_006_Pb10_Verificar_Aumente_Numero_Falla_Ejecuccion_RunLoad_test(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/	
		...
		String tdcQry2 =  " SELECT * \r\n"
				+ " FROM XXRFCO.XXRFCO_POS_FVT_DETL \r\n"
				+ " WHERE PID_ID = %s \r\n";
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
	...
	public String setTestFullName() {
		...
		return "ATC_FT_006_Pb10_Verificar_Aumente_Numero_Falla_Ejecuccion_RunLoad_test";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Verificar que aumente el numero de intentos cuando Falla la ejecucion";
	}
