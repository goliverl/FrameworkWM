...
public class ATC_FT_003_SM02_ValidarInfoNominaMOF extends BaseExecution {

	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_003_SM02_ValidarInfoNominaMOF_test(HashMap<String, String> data) throws Exception {
		...
		/**
		 * ALM
		 * Validar que la información de nómina de empleados se envie correctamente al sistema MOF
		 */
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
  ...
  public String setTestDescription() {
    return "Validar que la informacion de nomina de empleados se envie correctamente al sistema MOF";
  }
