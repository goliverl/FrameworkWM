...
public class ATC_FT_001_SM02_ValidarComportamientoInterface extends BaseExecution {
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_001_SM02_ValidarComportamientoInterface_test(HashMap<String, String> data) throws Exception {
...
/** UTILERIA *********************************************************************/
		...
		/**
		 * ALM 
		 * Validar el comportamiento de la interface SM02 (lo conmtrario al caso negativo)
		 * 
		 */
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
  ...
  public String setTestDescription() {
    return "Validar el comportamiento de la interface SM02";
  }
