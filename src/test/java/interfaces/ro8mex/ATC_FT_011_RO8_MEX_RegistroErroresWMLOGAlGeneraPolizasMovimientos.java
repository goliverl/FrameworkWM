...
//***************************************** Paso 8 *****************************************************************
		...
		addStep("Consultar los registros que no hayan sido procesados de la FEM_FIF_STG de la BD **FCRMSQA**, se hayan informado los campos REFERENCE_3 y REFERENCE_9, estén diferente de NULL y mayor a 1");	
...
//***************************************** Paso 9 y 10 *****************************************************************
		...
		addStep("Validar el registro de la ejecución de la interface RO8_MEX en la tabla WM WM_LOG_RUN de la BD **FCWML6QA**.");
...
//***************************************** Paso 13 *****************************************************************
		...
		addStep("Realizar la siguiente consulta para verificar que registre los errores  en la ejecución de la interfaz RO8_MEX en la tabla WM_LOG_ERROR de BD FCWMLQA. ");
