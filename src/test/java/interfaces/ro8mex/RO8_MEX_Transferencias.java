...
public class RO8_MEX_Transferencias extends BaseExecution {
	public String thread_id;
	@Test(dataProvider = "data-provider")
	public void ATC_FT_RO8_MEX_005_Transferencias(HashMap<String, String> data) throws Exception {
...
////	Paso 10  *************************************************
  ...
  assertFalse(av9, "No se obtiene informacion de la consulta");
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_RO8_MEX_005_Transferencias";
	}
