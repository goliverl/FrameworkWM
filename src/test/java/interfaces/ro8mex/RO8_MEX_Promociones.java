...
public class RO8_MEX_Promociones extends BaseExecution {
	public String thread_id;
	@Test(dataProvider = "data-provider")
	public void ATC_FT_RO8_MEX_003_Promociones(HashMap<String, String> data) throws Exception {
		...
		String tdcQueryStatusLog = "SELECT run_id,interface,start_dt,status,server " + " FROM WMLOG.wm_log_run"
				+ " WHERE interface = 'RO8_MEX_PROM' " + " and status= 'S' " + " and start_dt >= trunc(sysdate) " // FCWMLQA
...
////	Paso 10  *************************************************
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_RO8_MEX_003_Promociones";
	}
