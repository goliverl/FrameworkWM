...
public class RO8_GAS_Ventas extends BaseExecution {
	
	SeleniumUtil u;
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_RO8_GAS_003_Ventas(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/
		...
		String SelectCFG = "SELECT ATTRIBUTE1 AS PLAZA, ATTRIBUTE2 AS TRANCODE  " + " FROM WMUSER.wm_cfg_launcher "
				...
				+ " AND attribute3 ='VTAS'" + " AND auto_status = 'A'";// Posuser
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/
		...
		addStep("Verificar parametros configurados en la WMUSER.WM_CFG_LAUNCHER para ejecución AUTOMATICA plaza " + data.get("plaza"));
		...
		String dateExecution = pok.runIntefaceWmWithInput(data.get("interfase"), data.get("servicio"), data.get("executionType"), "executionType");
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_RO8_GAS_003_Ventas";
	}
