...
public class RO8_GAS_Compras extends BaseExecution {
	public String thread_id;
	 

	@Test(dataProvider = "data-provider")
	public void ATC_FT_RO8_GAS_002_Compras(HashMap<String, String> data) throws Exception {
...
//Paso 3  ****************** *******************************
		addStep("Ejecutar el servicio de la interface: RO8_GAS.Pub:runCPAS. Solicitando la ejecución del job: RO8_GAS.Pub:runCPAS.");
...
////	Paso 9  *************************************************
  ...
  assertFalse(av9, "No se obtiene informacion de la consulta");
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_RO8_GAS_002_Compras";
	}
