...
public class RO8GAS_Transferencias extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_RO8_GAS_006_Transferencias(HashMap<String, String> data) throws Exception {
		...
		String tdcQueryWmCfgLauncher = "SELECT ATTRIBUTE1 AS PLAZA, ATTRIBUTE2 AS TRANCODE FROM WMUSER.WM_CFG_LAUNCHER "
				+ "WHERE INTERFACE_NAME = 'RO08_GAS' " + "AND AUTO_STATUS= 'A' " + "AND ATTRIBUTE3 = 'TRANS' "
		...
		String tdcQueryFemFifStg1 = "SELECT ITEM, ITEM_DESC, TRAN_DATE, TRAN_CODE, REFERENCE_3, REFERENCE_9, ID"
				...
				+ data.get("plaza") + "'" + " AND tran_code = '30'" + " AND reference_3 IS NULL"
		...
		String Verificar = "SELECT reference_3, reference_9, item_desc FROM fem_fif_stg"
				...
				"AND CR_PLAZA = '" + data.get("plaza") + "' " + "AND tran_code = '30' "; // rms
		...
		pok.runIntefaceWmWithInput(data.get("interface"), data.get("servicio"),"AUTO","executionType");
...
////		Paso 9  *************************************************
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_RO8_GAS_006_Transferencias";
	}
