...
public class ATC_FT_019_PO4_EstabilizacionPO4ErroresGeneracionArchivoPMCTransmitirActualizacionFormasPagoFEMSA_PO4 extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_019_PO4_EstabilizacionPO4ErroresGeneracionArchivoPMCTransmitirActualizacionFormasPagoFEMSA_PO4_test(HashMap<String, String> data) throws Exception {

		/**
		 * Proyecto:Actualizacion tecnologica- BackOffice Oracle (Regresion Enero 2023)
		 * Caso de prueba: MTS-FT-019-CE PO4 Errores en la generación de archivo PMC para transmitir 
		 * actualización de formas de pago y cupones a los punto de venta por medio de la FEMSA_PO4
...
//***************************************** Paso 10 *****************************************************************
		...
		assertFalse(validaConsultaErrores, "No se ncontraron logs de errores en la tabla");
...
//***************************************** Paso 11 *****************************************************************
	...
	public String setTestDescription() {
		...
		return "Prueba de regresión para comprobar la no afectación en la funcionalidad principal de la interface PO4 "
				+ "al presentarse errores al generar el archivo PMC en los buzones de tiendas para actualizar "
				+ "formas de pago y cupones al punto de venta, al ser migrada la interface FEMSA_PO4 de  WM9.9 a WM10.5 ";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_019_PO4_EstabilizacionPO4ErroresGeneracionArchivoPMCTransmitirActualizacionFormasPagoFEMSA_PO4_test";
	}
