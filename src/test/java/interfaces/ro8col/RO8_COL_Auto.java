...
//SELECT * FROM fem_fif_stg
//WHERE     CR_PLAZA = '10BGA'
//      AND tran_code = 30
...
//      
//UPDATE fem_fif_stg
//SET reference_3 = null,
//reference_9 = null,
//tran_date = TO_DATE ('17/12/2020','DD/MM/YYYY')
//WHERE id = 47099952113
//AND CR_PLAZA = '10BGA';
//--AND tran_date >= TRUNC(SYSDATE-60);
...
public class RO8_COL_Auto extends BaseExecution {
	@Test(dataProvider = "data-provider")
	public void ATC_FT_RO8_COL_001_Auto(HashMap<String, String> data) throws Exception {
	...
	utils.sql.SQLUtil dbRms = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_RMS_COL,
		...
		System.out.println(consultaReference3);
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_RO8_COL_001_Auto";
	}
