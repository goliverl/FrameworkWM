...
public class Ps2_ValidarInsercionDeErrorEnXxse_Transaction_Error extends BaseExecution {
	@Test(dataProvider = "data-provider")
	public void ATC_FT_001_PS2_ValidarInsercionDeErrorEnXxse_Transaction_Error(HashMap<String, String> data) throws Exception {
...
//                Paso 2   ************************
		...
		if (!validar_Paso2) {
			Bar_code = Paso_2.getData(0, "BAR_CODE");
...
//      Paso 6 ************************************************
	...
	public String setTestFullName() {
		...
		return "ATC_FT_001_PS2_ValidarInsercionDeErrorEnXxse_Transaction_Error";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Terminada. Validar que se deposite correctamente la información en la tabla XXSE_TRANSACTION_ERROR de SINERGIA al insertarse un registro duplicado para la plaza";
	}
