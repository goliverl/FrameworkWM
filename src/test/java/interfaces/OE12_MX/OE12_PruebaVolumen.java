...
public class OE12_PruebaVolumen extends BaseExecution {
	...
	public void test(HashMap<String, String> data) throws Exception {
	 ...
	 String registrosStatusL = data.get("query200");
		...
		addStep("Ejecutar el siguiente query para validar que se tengan los 2000 registros información de (información de  sociedades,\r\n" + 
				...
				"relación de Estados Financieros y \r\n" + 
...
//  Paso 7  *********************************
	...
	//Primera parte
		...
		assertTrue("Se muestran errores relacionados al performance de la interface en relación con la carga ", validaerror1);
...
//Paso 8 **************************************************************************
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "MTC-FT-026 Validar prueba de volumen";
	}
