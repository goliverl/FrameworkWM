...
public class PR11SincronizacionDeInventarios extends BaseExecution {
	
	
@Test(dataProvider = "data-provider")
public void ATC_FT_001_PR11_SincronizacionDeInventarios(HashMap<String, String> data) throws Exception {
...
*/	
	...
	String tdcQueryInvFisico = "SELECT PID_ID, PV_INV_FIS, TO_CHAR(FECHA_ADM,'YYYYMMDD') FECHA_ADM FROM POS_INV" + 
			" WHERE PID_ID = '%s'" + 
			" AND PV_INV_FIS = 'F'";
...
addStep("Validar que exista documentos de tipo DOC_TYPE='INV' pendiente de procesar en la tabla POS_INBOUND_DOCS de POSUSER con STATUS = 'I' para la plaza.");
...
addStep("Ejecutar el servicio PR11.Pub:");				
			...
			String tdcIntegrationServerFormat = String.format(tdcQueryStatusLog,dateExecution);
...
addStep("Comprobar que se registra la ejecucion en WMLOG");
		...
		SQLResult paso3 = executeQuery(dbLog, tdcQueryStatusLog);
...
addStep("Validar que se actualice el estatus de los documentos procesados en la tabla POS_INBOUND_DOCS de POSUSER a STATUS = 'E'");
   		...
   		SQLResult paso6 = executeQuery(dbPos, proc);   		
   		
   		boolean procValue = paso6.isEmpty();
...
assertFalse(procValue, " No se muestran registros a procesar ");	
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return " Validar la sincronización de Inventarios para las plazas ";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_001_PR11_SincronizacionDeInventarios";
	}
