...
public class ATC_FT_002_PR11_SincronizacionDeInventariosExcel extends BaseExecution {
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_002_PR11_SincronizacionDeInventariosExcel_test(HashMap<String, String> data) throws Exception { 
...
addStep("Validar que se inserte la información de los documentos procesados en la tabla XXFC.XXFC_ITEM_LOC_POS de RETEK");
			...
			SQLResultExcel paso5 = executeQueryExcel(dbRms, xxfFormat);
...
assertFalse(procValue, " No se muestran registros a procesar ");		
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Validar la sincronizacion de Inventarios";
	}
