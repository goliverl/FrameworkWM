...
public class PE1AuthPeru extends BaseExecution {
	
 
	@Test(dataProvider = "data-provider")
	public void ATC_FT_003_PE1_PE1AuthPeru(HashMap<String, String> data) throws Exception {
		/* Utilerías *********************************************************************/
...
//							Paso 2
	...
	//Ejecuta el servicio PE1.Pub:runGetAuth
		String respuestaAuth = pe1Util.ejecutarRunGetAuthPeru(folio);	
...
//							Paso3
    ...
    //Ejecuta el servicio PE1.Pub:runGetAck
     ...
     //Se obtienen los datos folio y wm_code del xml de respuesta y se agregan a la evidencia
    folio = getSimpleDataXml(subRespuestaAck, "folio");
    wmCodeRequest = getSimpleDataXml(subRespuestaAck, "wmCode");	
    testCase.addTextEvidenceCurrentStep("Folio: "+folio);//Se agrega a la evidencia el folio
    testCase.addTextEvidenceCurrentStep("Wm Code: "+wmCodeRequest);//Se agrega a la evidencia el wm_code
...
//							Paso4	
	...
	public String setTestFullName() {
		...
		return "ATC_FT_003_PE1_PE1AuthPeru";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. FEMSA_PE1_PE1AuthPeru";
	}
