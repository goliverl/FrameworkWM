...
public class ATC_FT_OL11_OL14_004_Procesar_FlatFile_FEMSA_plazaMonchis extends BaseExecution {

	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_OL11_OL14_004_Procesar_FlatFile_FEMSA_plazaMonchis_test(HashMap<String, String> data) throws Exception {
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
  ...
  public String setTestDescription() {
    return "Validar que cuando la interface reciba un FlatFile de Serf�n y Plaza Los Monchis la procese de forma correcta." ;
  }
