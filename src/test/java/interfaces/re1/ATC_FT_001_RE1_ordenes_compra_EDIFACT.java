...
public class ATC_FT_001_RE1_ordenes_compra_EDIFACT extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_001_RE1_ordenes_compra_EDIFACT_test(HashMap<String, String> data) throws Exception {

		/**
		 * Proyecto:  (Regresion Enero 2023)
		 * Caso de prueba: Validar el envío de Ordenes de Compra del Proveedor 20859 al CEDIS 15CMF (EDIFACT - Formato 1).
		 * @author 
		 * @date 
		*/
...
//*************************************************Paso 2***********************************************************************************************************************
		...
		SQLResult ordenesCedis_r = dbPos.executeQuery(ordenesCedis_f);
...
addStep("Validar que el documento EDI enviado sea registrado en la tabla edi_outbound_docs de RETEK ");
	...
	public String setTestFullName() {
		...
		return "ATC_FT_001_RE1_ordenes_compra_EDIFACT_test";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Terminado. Validar el envío de Ordenes de Compra del Proveedor al CEDIS (EDIFACT - Formato 1)";
	}
