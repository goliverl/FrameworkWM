...
public class ATC_FT_003_RE1_ordenes_compra_EDIFACT_IMMEX extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_003_RE1_ordenes_compra_EDIFACT_IMMEX_test(HashMap<String, String> data) throws Exception {

		/*update WMUSER.edi_order_control set wm_status = 'L'                                                                 
          where supplier = '20859' 
          AND load_batch_id = '30194108';
        */
		/*
		 * Utilerías
		 ********************************************************************************************************************************************/
...
addStep("Validar que el documento EDI enviado sea registrado en la tabla edi_outbound_docs de RETEK ");
	...
	public String setTestFullName() {
		...
		return "ATC_FT_003_RE1_ordenes_compra_EDIFACT_IMMEX_test";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. ATC-FT-009-Validar ejecución de interface FEMSA_RE1 EDIFACT";
	}
