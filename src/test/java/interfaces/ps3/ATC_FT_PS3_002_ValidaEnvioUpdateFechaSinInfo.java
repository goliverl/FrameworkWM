...
public class ATC_FT_PS3_002_ValidaEnvioUpdateFechaSinInfo extends BaseExecution {
	@Test(dataProvider = "data-provider")
	public void ATC_FT_PS3_002_ValidaEnvioUpdateFechaSinInfo_test(HashMap<String, String> data) throws Exception {
...
//*************************************************Paso 2***********************************************************************************************************************
		...
		addStep("Validar que no haya informacion de la ultima ejecución para la interfaz PS3 en POSUSER:");
		...
		assertTrue(ValidInfEjecRes," existe  informacion de la ultima ejecucion para la interfaz PS3 en POSUSER");
...
//********************************************Paso 6**************************************************************************************************************************
		...
		addStep("Validar que en la tabla WM_LAST_EXEC_DATETIME se inserto un nuevo registro con la ultima fecha de ejecucion.");
		...
		assertFalse(ValidUpdtTabReq,"No se inserto un nuevo registro con la ultima fecha de ejecucion");
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Terminada. Validar que se inserte un nuevo registro en la tabla WM_LAST_EXEC_DATETIME de POSUSER, al no existir información de última ejecucion";
	}
