...
public class CS01_Actualizar_Tienda_con_Bitacora_ID extends BaseExecution{
	@Test(dataProvider = "data-provider")
	public void ATC_FT_002_CS01_Actualizar_Tienda_con_Bitacora_ID(HashMap<String, String> data) throws Exception {
...
/* Utilerias *********************************************************************/		
		...
		/**
		 * ALM
		 * Actualizar correctamente la Tienda con Bitacora_ID igual a 69363.
		 */
...
//**********************************************Paso 1	****************************************************************************
				...
				SQLResult VonsultaConfig = executeQuery(dbPuser, ConsConfig);
				
				boolean VonsultaConfigur = VonsultaConfig.isEmpty();
				
					if (!VonsultaConfigur) {
				
					testCase.addQueryEvidenceCurrentStep(VonsultaConfig);
					
				
					}
					
				System.out.println(VonsultaConfigur);

				assertFalse(VonsultaConfigur, "No se encontro la configuracion en la tabla WM_INTERFASE_CONFIG" );
...
//*******************************************************Paso 4************************************************************************
		...
		addStep("Confirmar que exista registro de la correcta ejecucion de la interfaz en la tabla  WM_LOG_RUN de la BD WMLOG para la interfaz CS01.");
		...
		assertFalse(validaStatus, "El estatus de la ejecucion termino en E");
...
//**************************************************Paso 5 **************************************************************************
		...
		assertFalse(threads1,"No se generaron threads en la tabla o el estatus de la ejecucion fue E");
	
//**************************************************Paso 6 ***************************************************************************		
 
		
		addStep("Comprobar que se actualicen registros en la tabla XX_NOMCOM_CNT_SAP de la BD CNT en donde WM_STATUS es igual a 'E'");
...
//		addStep("Comprobar que se ejecuto correctamente el servicio SAP (FEMSERV_SAP).");
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. CS01 Actualizar correctamente la Tienda con Bitacora_ID";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_002_CS01_Actualizar_Tienda_con_Bitacora_ID";
	}
