...
public class Respaldarcomisiones_Banamex_Aguascalientes extends BaseExecution {
	...
	public void ATC_FT_001_Eo05_Respaldarcomisiones_Banamex_Aguascalientes(HashMap<String, String> data) throws Exception {
...
/** UTILERIA *********************************************************************/
	...
	//	utils.sql.SQLUtil dbEbs = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_EBS, GlobalVariables.DB_USER_EBS, GlobalVariables.DB_PASSWORD_EBS);
		...
		/**
		 * ALM
		 * Respaldar comisiones de monedero de Banamex, plaza Aguascalientes
		 */
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
  ...
  public String setTestFullName() {
    return "ATC_FT_001_Eo05_Respaldarcomisiones_Banamex_Aguascalientes" ;
  }

  @Override
  public String setTestDescription() {
    return "Enviar solicitud de folio para una transaccion de pago" ;
  }
