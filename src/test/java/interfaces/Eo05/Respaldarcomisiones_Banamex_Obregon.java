...
public class Respaldarcomisiones_Banamex_Obregon extends BaseExecution {
	...
	public void ATC_FT_005_Eo05_Respaldarcomisiones_Banamex_Obregon(HashMap<String, String> data) throws Exception {
...
/** UTILERIA *********************************************************************/
	...
	//	utils.sql.SQLUtil dbEbs = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_EBS, GlobalVariables.DB_USER_EBS, GlobalVariables.DB_PASSWORD_EBS);
		...
		/**
		 * ALM
		 * Respaldar comisiones de monedero de Banamex, plaza Obregon
		 */
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
  ...
  public String setTestFullName() {
    return "ATC_FT_005_Eo05_Respaldarcomisiones_Banamex_Obregon" ;
  }
