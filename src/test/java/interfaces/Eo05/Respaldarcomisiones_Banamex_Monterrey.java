...
public class Respaldarcomisiones_Banamex_Monterrey extends BaseExecution {
	...
	public void ATC_FT_004_Eo05_Respaldarcomisiones_Banamex_Monterrey(HashMap<String, String> data) throws Exception {
...
/** UTILERIA *********************************************************************/
	...
	//	utils.sql.SQLUtil dbEbs = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_EBS, GlobalVariables.DB_USER_EBS, GlobalVariables.DB_PASSWORD_EBS);
		...
		/**
		 * ALM
		 * Respaldar comisiones de monedero de Banamex, plaza Monterrey
		 */
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
  ...
  public String setTestFullName() {
    return "ATC_FT_004_Eo05_Respaldarcomisiones_Banamex_Monterrey" ;
  }

  @Override
  public String setTestDescription() {
    return "Construido. Enviar solicitud de folio para una transacci�n de pago" ;
  }
