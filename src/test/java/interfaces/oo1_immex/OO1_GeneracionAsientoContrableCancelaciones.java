...
public class OO1_GeneracionAsientoContrableCancelaciones extends BaseExecution {
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_002_oo1_immex_GeneracionAsientoContrableCancelaciones(HashMap<String, String> data) throws Exception {
...
/* Utilerías ********************************************************************************************************************************************/
 ...
 /* Variables ******************************************************************************************************************************************/
	...
	//Paso 1
		...
		String infoProcesar = "SELECT ACA.BANK_ACCOUNT_NAME, substr(SITE.VENDOR_SITE_CODE,0,5) AS VENDOR_SITE, ACA.VOID_DATE\r\n" + 
				...
				"AND ACA.ATTRIBUTE2 <> '0'\r\n" + 
				"AND ACA.ATTRIBUTE3 IS NOT NULL\r\n" + 
				"AND ACA.ATTRIBUTE4 IS NULL\r\n" + 
				"AND TO_DATE(ACA.ATTRIBUTE3,'YYYYMMDD HH24MISS')<ACA.LAST_UPDATE_DATE\r\n" + 
				"AND GCC.SEGMENT3= '"+data.get("CR_PLAZA") +"' \r\n" + 
				"AND SUP.VENDOR_ID = ACA.VENDOR_ID        \r\n" + 
				"AND SITE.VENDOR_SITE_ID = ACA.VENDOR_SITE_ID  \r\n" + 
				"GROUP BY ACA.BANK_ACCOUNT_NAME, substr(SITE.VENDOR_SITE_CODE,0,5), ACA.VOID_DATE ";
		...
		//Paso 4
		String actAtributosOrafamiex = "SELECT aca.bank_account_name,aca.check_id, aca.attribute3, aca.attribute4\r\n" + 
				...
				"SELECT SITE.VENDOR_SITE_ID FROM AP.AP_SUPPLIER_SITES_ALL SITE\r\n" + 
...
//Pasos *****************************************************************************************************************************************************************		
		...
		addStep("Validar que existe información de Pagos pendientes de procesar para la Plaza.");   
...
//***************************************************************************************************************************************************************************************
			...
			addStep("Validar la actualización del atributo 4 y 3 en la tabla ap_checks_all de ORAFINIMMEX.");
			...
			System.out.println(actAtributosOrafamiex);
			 ...
			 String  attribute4 = actualizacionAtributosOrafamiex_R.getData(0, "ATTRIBUTE4");
			...
			assertFalse("Los campos atributo 3 y 4 no  se actualizaron con el id del journal ", validaActualizacion);
...
//************************************************************************************************************************************************************************************			
			...
			String insercionLineasPolizas_f = String.format(insercionLineasPolizas,attribute4);
...
//**************************************************************************************************************************************************************************************
	...
	public String setTestFullName() {
		...
		return "ATC_FT_002_oo1_immex_GeneracionAsientoContrableCancelaciones";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Validar la generación del asiento contable para las Cancelaciones ";
	}
