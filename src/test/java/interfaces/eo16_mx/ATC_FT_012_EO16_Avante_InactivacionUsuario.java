...
/**
 *  I21045-Administración de Identidades-Avante-CC: MTC-FT-020-Realizar una Inactivación de Usuario, Exitosa
 * Desc:
 * Se requiere un método de inactivación de usuarios en el sistema EBS 12.2.4
 * @author Roberto Flores
 * @date   2022/07/22
 */
public class ATC_FT_012_EO16_Avante_InactivacionUsuario  extends BaseExecution{

	@Test(dataProvider = "data-provider")
	public void ATC_FT_012_EO16_Avante_InactivacionUsuario_Test(HashMap<String, String> data) throws Exception {
		...
		String tdcQueryValidate = "SELECT * FROM  POSUSER.WM_TRANSACTION_EO16_MX WHERE OPERATION='UpdUserInactivate' AND START_DT >= TO_DATE('%s','dd/mm/yyyy hh24:mi:ss')";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		testCase.addQueryEvidenceCurrentStep(connectionResult, true);
		
		assertFalse(connectionResult.isEmpty(), "No se encontró registro en la BD");
...
//		assertFalse(connection, "La tabla no contiene la información o STATUS diferente a " + data.get("status"));	    
	...
	public String setTestFullName() {
		return "ATC_FT_012_EO16_Avante_InactivacionUsuario_Test";
	}

	@Override
	public String setTestDescription() {
		return "MTC-FT-020-Realizar una Inactivación de Usuario, Exitosa";
	}
