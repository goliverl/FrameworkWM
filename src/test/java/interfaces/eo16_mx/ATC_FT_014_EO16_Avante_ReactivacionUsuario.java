...
/**
 *  I21045-Administración de Identidades-Avante-CC: MTC-FT-026-Realizar una Reactivación de Usuario, Exitosa
 * Desc:
 * Se requiere un método de reactivación de usuarios en el sistema EBS 12.2.4
 * @author Roberto Flores
 * @date   2022/07/22
 */
public class ATC_FT_014_EO16_Avante_ReactivacionUsuario extends BaseExecution{

	@Test(dataProvider = "data-provider")
	public void ATC_FT_014_EO16_Avante_ReactivacionUsuario_Test(HashMap<String, String> data) throws Exception {
...
//		assertFalse(connection, "La tabla no contiene la información o STATUS diferente a " + data.get("status"));	    
	...
	public String setTestFullName() {
		return "ATC_FT_014_EO16_Avante_ReactivacionUsuario_Test";
	}

	@Override
	public String setTestDescription() {
		return "MTC-FT-026-Realizar una Reactivación de Usuario, Exitosa";
	}
