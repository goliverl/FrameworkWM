 ...
 * Desc:
 * Se requiere validar el método de reactivación de usuarios en el sistema EBS 12.2.4 con los siguientes parámetros de entrada:
 * • Nombre de usuario: Este dato será la llave para determinar el usuario de interés. 
 * Para este caso deberá simularse una desconexión con el WS de WM apagando o deshabilitando el adapter DBS_ORAFIN_IDM_NT.
 * Obteniendo una Excepción en el servicio: Código de respuesta 500 | Se presento un error en el servicio EBS.
 * @author Roberto Flores
 * @date   2022/07/22
 */
public class ATC_FT_015_EO16_Avante_ReactivacionUsuarioAdapterOff  extends BaseExecution{

	@Test(dataProvider = "data-provider")
	public void ATC_FT_015_EO16_Avante_ReactivacionUsuarioAdapterOff_Test(HashMap<String, String> data) throws Exception {
		...
		String tdcQueryValidate = "SELECT * FROM  POSUSER.WM_TRANSACTION_EO16_MX WHERE OPERATION='UpdUserActivate' AND START_DT >= TO_DATE('%s','dd/mm/yyyy hh24:mi:ss')";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public String setTestFullName() {
		return "ATC_FT_015_EO16_Avante_ReactivacionUsuarioAdapterOff_Test";
	}

	@Override
	public String setTestDescription() {
		return "MTC-FT-027-Realizar una Reactivación de Usuario, Excepción en el servicio";
	}
