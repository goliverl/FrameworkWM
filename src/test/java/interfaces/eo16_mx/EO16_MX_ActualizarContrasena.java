...
public class EO16_MX_ActualizarContrasena extends BaseExecution {
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
		...
		assertFalse(connection, "La tabla no contiene la informaci�n o STATUS diferente a " + data.get("status"));	    
