...
/**
 *  I21045-Administracion de Identidades-Avante-CC: MTC-FT-018-Realizar una Actualizaci�n de Contrase�a a un Usuario, Excepci�n en el servicio
 * Desc:
 * Se requiere validar el metodo de actualizaci�n de contrase�a de usuarios en el sistema EBS 12.2.4
 * @author Oliver Martinez
 * @date   2022/08/08
 */

public class ATC_FT_010_EO16_Avante_ActualizarContrasenaExcepcion extends BaseExecution{
	@Test(dataProvider = "data-provider")
	public void ATC_FT_010_EO16_Avante_ActualizarContrasenaExcepcion_Test (HashMap <String, String> data) throws Exception{
		/*
		 * Utileria*********************************************************************/
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "ATC-FT-018-Realizar una Actualizacion de Contrasena a un Usuario, Excepcion en el servicio";
	}
