...
public class OR1_OG_RegistrarInfoConPlazaYDistrito extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_001_OR1_OG_Registrar_Info_Plaza_Y_Distrito(HashMap<String, String> data) throws Exception {
...
//Paso 1 *************************		
		addStep("Validar que existan información de ajustes de inventarios para la plaza "+ data.get("plaza") +" y distrito "+ data.get("distrito") +" pendiente por procesar en la tabla XXFC_AJUSTE_SALDOS_AUTOMATICOS de ORACLE AR.");
...
//Paso 2 *************************		
		addStep("Ejecutar la interface OR1_OG.Pub:run para enviar la información de los ajustes de inventarios de ORACLE AR a RETEK para la plaza "+ data.get("plaza") +" y distrito "+ data.get("distrito") +".");
...
//Paso 6 *****************
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Terminado. Registrar en Retek RMS la información de ajustes de inventarios desde Oracle AR.";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_001_OR1_OG_Registrar_Info_Plaza_Y_Distrito";
	}
