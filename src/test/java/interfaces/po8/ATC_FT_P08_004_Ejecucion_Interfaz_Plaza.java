...
public class ATC_FT_P08_004_Ejecucion_Interfaz_Plaza extends BaseExecution {
	...
	public void ATC_FT_P08_004_Ejecucion_Interfaz_Plaza_test (HashMap<String, String> data) throws Exception {
		...
		utils.sql.SQLUtil dbLog = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_WMLOG_DEV,GlobalVariables.DB_USER_WMLOG_DEV, GlobalVariables.DB_PASSWORD_WMLOG_DEV);
...
//*************************************************** Paso 4 ***********************************************************
		...
		if (!paso4) {
			testCase.addDocumentEvidence(finn.getRelativePath(), " 4. Verificar la informacion enviada a FINANZAS.");
		}
...
//*************************************************** Paso 5 ************************************************************
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Validar la operacion para el envio de documentos SDI (Saldo Diario) a FINANZAS.";
	}
