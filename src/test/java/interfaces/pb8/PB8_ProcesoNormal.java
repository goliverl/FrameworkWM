...
public class PB8_ProcesoNormal extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_PB8_001_Verifica_Proceso_Normal(HashMap<String, String> data) throws Exception {
		...
		String ValidarInsumo = "SELECT DISTINCT(SUBSTR(PV_DOC_NAME,4,5)) PV_PLAZA, SUBSTR (PV_DOC_NAME,9,5) PV_TIENDA, STATUS, DOC_TYPE, ID" + 
				" FROM POSUSER.POS_INBOUND_DOCS I, POSUSER.POS_FVT F, POSUSER.POS_FVT_DETL D" + 
				" WHERE I.STATUS = 'I' " + 
				" AND I.ID = F.PID_ID " + 
				" AND I.ID = D.PID_ID"	+ 
				" AND I.PARTITION_DATE > TRUNC(SYSDATE -10)" +
		...
		String validarStatusE = "SELECT DISTINCT(SUBSTR(PV_DOC_NAME,4,5)) PV_PLAZA, SUBSTR (PV_DOC_NAME,9,5) PV_TIENDA, STATUS, DOC_TYPE, ID " + 
				"FROM POSUSER.POS_INBOUND_DOCS I, POSUSER.POS_FVT F, POSUSER.POS_FVT_DETL D WHERE I.STATUS = 'E' " + 
				"AND I.ID = F.PID_ID  AND I.ID = D.PID_ID " + 
				"AND I.DOC_TYPE = 'FVT'  AND I.ID='%s' " ;
...
//		Paso 2	************************	
		...
		addStep("Invocar el servicio PB8.Pub:run ");
...
//		Paso 4  *************************************************
		...
		String queryFormat = String.format(validarStatusE, ID);
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PB8_001_Verifica_Proceso_Normal";
	}
