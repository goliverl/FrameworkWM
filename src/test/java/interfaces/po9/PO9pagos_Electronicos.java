...
public class PO9pagos_Electronicos extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_PO9_001_Valida_Envio_Pagos_Electronicos(HashMap<String, String> data) throws Exception {
...
//Paso 4	************************
		...
		System.out.println("VACIO? " + paso4.isEmpty());
		if (!ejecucion) {
		...
		if (validateStatus) {
			...
			testCase.addTextEvidenceCurrentStep("Se encontro un error en la busqueda del estatus 'S' "
					+ "en la tabla WM_LOG_RUN de WM_LOG");
			testCase.addQueryEvidenceCurrentStep(paso4);
		}
		// 
...
//pasos 
		...
		SQLResult fin = executeQuery(dbEbs, consultaDetalle);
	...
	public String setTestFullName() {
		...
		return "ATC_FT_PO9_001_Valida_Envio_Pagos_Electronicos";
	}
