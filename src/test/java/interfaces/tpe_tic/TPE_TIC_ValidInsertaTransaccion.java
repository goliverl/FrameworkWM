...
//		Paso 1	************************	
			...
			addStep("Ejecutar el servicio: TPE.TIC.Pub:request e ingresar la información del XML de entrada para el campo: xmlln.");
...
//			Paso 3 **************************************************************
			...
			addStep("Validar que la información se insertó correctamente en la tabla tpe_fr_transaction");
...
//				Paso 4 **************************************************************
				...
				addStep("Validar que la información se insertó correctamente en la tabla tpe_fcp_activity de TPEMON.");
