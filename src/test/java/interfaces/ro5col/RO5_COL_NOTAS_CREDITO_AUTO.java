...
public class RO5_COL_NOTAS_CREDITO_AUTO extends BaseExecution {
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_003_RO5_COL_Ejecucion_Interfaz_Procesamiento_Notas_Modo_AUTO(HashMap<String, String> data) throws Exception {
...
*/
		...
		String validarInsumo ="SELECT shipment, order_no, SUPPLIER_ID, TERMS_DESC, LOC, REFERENCE_3, REFERENCE_8, receive_date "
		...
		String procesoRtvhead ="SELECT shipment, order_no, supplier_id, receive_date, reference_3, reference_8 "
				+ "FROM fem_rechead_temp " + 
				" WHERE TRUNC(receive_date) BETWEEN "
				+ " TO_DATE('%s','DD/MM/YYYY')" + 
				" AND TO_DATE('%s','DD/MM/YYYY')" + 
		...
		String tdcQueryIntegrationServer = "SELECT run_id,interface, start_dt, end_dt, status, server, (END_DT - START_DT)*24*60  FROM wmlog.wm_log_run" + 
...
//		Paso 7  *************************************************
		...
		String procesoRtvheadFormat = String.format(procesoRtvhead, fechaMin, fechaMax);
		
		System.out.println(procesoRtvheadFormat);
		
		 SQLResult RTV = dbRMSCOL.executeQuery(procesoRtvheadFormat);
	...
	public String setTestFullName() {
		...
		return "ATC_FT_003_RO5_COL_Ejecucion_Interfaz_Procesamiento_Notas_Modo_AUTO";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Ejecución de la interfaz para el procesamiento de las Notas en modo AUTO.";
	}
