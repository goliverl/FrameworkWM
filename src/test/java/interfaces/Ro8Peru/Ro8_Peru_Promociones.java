...
public class Ro8_Peru_Promociones extends BaseExecution {
	public String thread_id;
	@Test(dataProvider = "data-provider")

	public void ATC_FT_RO8_Peru_003_Peru_Promociones(HashMap<String, String> data) throws Exception {
...
//		Paso 1	**********************************************	
		...
		SQLResult Paso1 = executeQuery(dbPuserPeru, tdcQueryPaso1);
...
//Paso 2	**********************************************	
		...
		SQLResult Paso2 = executeQuery(dbRmsPeru, tdcQueryPaso2);
...
//	Paso 4_1 *************************************************
		...
		SQLResult paso4_1 = executeQuery(dbLogPeru, FormatoPaso4);
...
////	Paso 9  *************************************************
	...
	public String setTestFullName() {
		...
		return "ATC_FT_RO8_Peru_003_Peru_Promociones";
