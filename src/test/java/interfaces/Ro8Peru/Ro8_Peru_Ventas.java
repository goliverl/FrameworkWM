...
public class Ro8_Peru_Ventas extends BaseExecution {
public String Thread_id;

	@Test(dataProvider = "data-provider")

	public void ATC_FT_RO8_Peru_006_Peru_Ventas(HashMap<String, String> data) throws Exception {
...
public String setTestFullName() {
	...
	return "ATC_FT_RO8_Peru_006_Peru_Ventas";
