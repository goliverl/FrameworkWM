...
/**
 * MTC-FT-004-TPE_OLS_D Transacci�n exitosa de pago de servicio.<br>
 * MTC-FT-005-TPE_OLS_D Transacci�n no exitosa de pago de servicio.<br>
 * MTC-FT-007-TPE_OLS_D Reversa exitosa por ACK negativo.<br>
 * Desc: En este escenario, se estara validando que se realice se pueda realizar un 
 * pago de forma exitosa y no exitosa de un servicio  a un proveedor.
 * 
 * @author Oliver Martinez
 * @date 04/21/2023
 */

public class ATC_FT_002_OLS_D_TransaccionDePagoDeServicioYReversaAck extends BaseExecution{
	@Test(dataProvider = "data-provider")
	public void ATC_FT_002_OLS_D_TransaccionDePagoDeServicioYReversaAck_test (HashMap<String, String> data) throws Exception{
		/*
		 * Utileria******************************************************/
...
//		System.out.println("wmCode: " + wmCode + " Total: " + total);
		...
		/******************************Paso 5****************************/
		addStep("Realizar conexion a la BD FCTPEQA");
		...
		/******************************Paso 6****************************/
		addStep("Ejecutar la siguiente consulta en la BD FCTPEQA para validar que se registre la transaccion "
		...
		softAssert.assertFalse(transaction.isEmpty(), "Paso 6: No se obtuvo registro de la transaccion.");
		/******************************Paso 7****************************/
		addStep("Realizar conexion a la BD FCWMLTAEQA");
		...
		/******************************Paso 8****************************/
		addStep("Ejecutar la siguiente consulta en la BD FCWMLTAEQA para validar que se registre la ejecuci�n hecha por el canal no seguro:");
...
//		softAssert.assertTrue(unsafeTransaction.isEmpty(), "Paso 8: La transaccion no viajo por un canal seguro");
		...
		boolean validationTRN03 = errorRecords.isEmpty();
		testCase.addQueryEvidenceCurrentStep(errorRecords);
		assertFalse(validationTRN03, "No se encontro ningun error en FCWMLTAEQA");
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_002_OLS_D_TransaccionDePagoDeServicioYReversaAck_test";
	}
