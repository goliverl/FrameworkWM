...
public class OG04_ReenviarpagodeFacturaDeOracleEBSARaControlGas extends BaseExecution {
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_OG04_002_ReenviarpagodeFacturaDeOracleEBSARaControlGas(HashMap<String, String> data) throws Exception {
		...
		String tdcQueryPaso3 = " Select * from  xxog.xxog_ar_recibos_h "
				+ " where wm_status = 'L' AND "
				+ " id_site = 136413 AND "
				+ " wm_status = 'F' ";
		
		String tdcQueryPaso4 = " SELECT * FROM wmlog.wm_log_run "
				+ " WHERE interface = 'OG04' AND "
				+ " TRUNC (start_dt) = TRUNC (SYSDATE) AND "
				+ " status = 'S' "
				+ " ORDER BY 3 DESC; ";
		...
		addStep(" Tener informacion pendiente de enviar en la tabla xxog_ar_recibos_h de ORAFIN ");
		...
		addStep(" Validar que el detalle del pago de facturas correspondientes al site 136413 en la tabla "
				+ "xxog_ar_recibos_l de ORAFIN, tenga el campo wm_status=L.");
		...
		addStep(" Validar el campo wm_status=L, con wm_status=F, en la "
				+ "tabla xxog_ar_recibos_h de de la BD de ORAFIN.");

		System.out.println(GlobalVariables.DB_HOST_FCWMLQA);

		System.out.println(tdcQueryPaso3);

		SQLResult Paso3 = executeQuery(dbFCFINQA, tdcQueryPaso3);
		...
		public String setTestDescription() {
			// TODO Auto-generated method stub
			return "Construido. Enviar la información de pagos de facturas que anteriormente fallaron con respecto al id_site ID_NUM del sistema Oracle EBS AR hacia el sistema ControlGas";
		}
		...
		public String setTestFullName() {
			// TODO Auto-generated method stub
			return "ATC_FT_OG04_002_ReenviarpagodeFacturaDeOracleEBSARaControlGas";
		}
