...
public class RO4_COL_NOTAS_ModoAuto extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_RO4_COL_003_Notas_ModoAuto(HashMap<String, String> data) throws Exception {
		...
		String validaInsumo = "SELECT RTV_ORDER_NO, SUPPLIER_ID, STORE, COMPLETED_DATE, REFERENCE_3, REFERENCE_8"
...
//		Paso 1	************************		
		...
		addStep("Verificar que existen datos pendientes por procesar en la tabla fem_rtvhead_temp  de RETEK para la plaza correspondiente" );
...
//		Paso 5  *************************************************
		...
		/* registro = dbRms.executeQuery(validarRegistroRtvhead2);
	...
	public String setTestFullName() {
		...
		return "ATC_FT_RO4_COL_003_Notas_ModoAuto";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Terminada. Ejecucion de la interfaz para el procesamiento de Notas en modo AUTO";
	}
