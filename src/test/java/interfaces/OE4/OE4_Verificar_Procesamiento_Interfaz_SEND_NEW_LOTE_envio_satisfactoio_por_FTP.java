...
public class OE4_Verificar_Procesamiento_Interfaz_SEND_NEW_LOTE_envio_satisfactoio_por_FTP extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_OE4_005_Verificar_Interfaz_SEND_NEW_LOTE_RESPONSE_Satisf_FTP(HashMap<String, String> data) throws Exception {
		...
		String tdcQueryPaso4 = " SELECT * FROM WMUSER.xxfc_lotes_dollars \r\n"
		...
		String tdcQueryPaso5 = " SELECT * FROM xxfc_dollar_sales \r\n"
...
// Paso 1_2 ***************************
		...
		System.out.println(GlobalVariables.DB_HOST_Ebs);
		String FormatoPaso2 = String.format(tdcQueryPaso1_2, OraCia);
...
// Paso 5 ******************************
		...
		addStep("Validar que el archivo se coloco en el directorio FTP del proveedor [yyyyMMdd_01.txt].\r\n");
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Bloqueado. Verificar procesamiento de la interfaz, modulo SEND_NEW_LOTE, envío satisfactorio por FTP.";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_OE4_005_Verificar_Interfaz_SEND_NEW_LOTE_RESPONSE_Satisf_FTP";
	}
