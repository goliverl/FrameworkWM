...
public class PR77_Validar_Envio_ANS extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_PR77_002_Validar_Envio_ANS(HashMap<String, String> data) throws Exception {
		...
		String tdcInfo_Pendiente = "SELECT h.CEDIS,h.CRPLAZA, h.TSF_NO, h.BOL_NBR, h.STATUS,h.CREATE_DATE, h.RUTA, h.SHIP_TS, h.GENERADO, h.CR_TIENDA FROM RDM100.xxfc_posterior_embarque h "
				...
				+ "h.status = 'S' " + "AND h.wm_status_asn = 'I' " + "and h.FECHA_INSERT >= SYSDATE-7 "
...
//		Paso 1	************************		
		...
		System.out.println(GlobalVariables.DB_PASSWORD_RDM_63);
...
//Paso 3    ************************		
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PR77_002_Validar_Envio_ANS";
	}
