...
public class ATC_FT_001_OE14_MX_EnviarConfirmacionFacturas extends BaseExecution{
	@Test(dataProvider = "data-provider")
	public void ATC_FT_001_OE14_MX_EnviarConfirmacionFacturas_test(HashMap<String, String> data) throws Exception {
...
/** UTILERIA *********************************************************************/	
		...
		String selectCamposID = data.get("validarQuery");
		...
		String tdcIntegrationServerFormat = "select * from (SELECT Tbl.run_id,interface, start_dt, end_dt, status, server "
				+ "FROM WMLOG.WM_LOG_RUN Tbl " + "WHERE INTERFACE LIKE '%OE14MX_EAF%' "
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
		...
		System.out.println(GlobalVariables.DB_HOST_AVEBQA);
		String selectFormat = String.format(select1_part1, data.get("variable1"), data.get("variable2"));	
		String selectFormat2 = String.format(select1_part2, data.get("variable1"), data.get("variable2"));	
		...
		System.out.println(GlobalVariables.DB_HOST_AVEBQA);
		String selectFormat10 = String.format(selectCamposID, data.get("variable1"), data.get("variable2"));
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Poder enviar las información de  confirmación de facturas FI  mediante la ejecución de un  ws invocado por Xpertal la información será enviada de las tablas de paso de Oracle.";
	}
