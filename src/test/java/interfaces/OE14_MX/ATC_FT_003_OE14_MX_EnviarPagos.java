...
public class ATC_FT_003_OE14_MX_EnviarPagos extends BaseExecution{
	@Test(dataProvider = "data-provider")
	public void ATC_FT_003_OE14_MX_EnviarPagos_test(HashMap<String, String> data) throws Exception {
...
/** UTILERIA *********************************************************************/	
		...
		String tdcIntegrationServerFormat = "select * from (SELECT Tbl.run_id,interface, start_dt, end_dt, status, server "
				+ "FROM WMLOG.WM_LOG_RUN Tbl " + "WHERE INTERFACE LIKE '%OE14MX_P%' "
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
		...
		System.out.println(GlobalVariables.DB_HOST_AVEBQA);
		selectFormat = String.format(select2_part1, data.get("variable1"));	
		//selectFormat2 = String.format(select2_part2, data.get("variable1"));	
		System.out.println(selectFormat);		
		...
		if (!av10) {	
			...
			//testCase.addQueryEvidenceCurrentStep(queryDate);
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Poder enviarla información de pagos de los proveedores  mediante la ejecución de una interfaz hacía Xpertal,la información será tomada de las tablas de paso de EBS.";
	}
