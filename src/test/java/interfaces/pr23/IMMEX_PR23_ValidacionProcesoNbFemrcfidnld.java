...
/**
 * I21078 Impactos de Núcleo a IMMEX: ATM-FT-008-Validar ejecución de interface FEMSA_PR23 (proceso NB_FEMRCFIDNLD)
 * Desc:
 * Se requiere la ejecución de la interface FEMSA_PR23 que procesa archivos REC (recibos de transferencias de entrada de Cedis o de tienda), 
 * ésto una vez ejecutado el proceso del fin día desde el XPOS (archivo REC),
 * para asegurar que el proceso NB_FEMRCFIDNLD mantenga fluyendo la información de las tablas:
 *	·	RMS_R.V.FEM_RECHEAD_TEMP
 *	·	RMS_R.V_FEM_RECDETAIL_TEMP
 * @author Roberto Flores
 * @date   2022/06/06
 */
public class IMMEX_PR23_ValidacionProcesoNbFemrcfidnld extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_PR_23_002_TransaccionExitosaPagoMercadoLibre(HashMap<String, String> data) throws Exception {
		
		testCase.setPrerequisites("*1.-Contar con acceso a las BDs de FCWM6QA,FCWMLQA y de FCRMSQA (RMS10)\r\n" + 
				"2.-Contar con el nombre y grupo del Job de Control-M para la interface FEMSA_PR23 de WM10.5\r\n" + 
				"3.-Tener acceso al repositorio destino donde se almacena un archivo .dat en el servidor FTP_RMS: RTKRMS, Path: /u04/retek/rmsqa/batch/wmworking/REC\r\n" + 
				"4.-Contar con el apoyo del equipo de XPOS para generar las transacciones correspondientes y ejecutar el proceso del FIN DÍA para que llegue el archivo REC al buzón del FTP\r\n" + 
				"5.-Acceso a Control-M");
		...
		String qryInformacionPendiente = "SELECT ID, pv_cve_mvt, created_date, pv_ced_id, pv_cr_from_loc, tsf_no, ext_ref_no, order_no\r\n" + 
				...
				"               TO_CHAR (created_date, 'DD/MM/YYYYHH24MISS') created_date,\r\n" + 
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
		 ...
		 * Paso 8
		 * **************************************************************************************************************************************/
		addStep("Verificar la información disponible para procesar en FCRMSQA.");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 * Paso 10
		 * **************************************************************************************************************************************/
		addStep("Ejecución PR23 control-M");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 * Paso 12
		 * **************************************************************************************************************************************/
		addStep("Establecer la conexión con la BD *FCWMLQA*");
		 ...
		 * Paso 13
		 * **************************************************************************************************************************************/
		addStep("Verificar en la BD *FCWMLQA*  que la interfaz terminó con éxito en WMLOG.");
		 ...
		 * Paso 18
		 * **************************************************************************************************************************************/
		addStep("Establecer la conexión con filezilla con  el servidor FTP de RMS");
		 ...
		 * Paso 19
		 * **************************************************************************************************************************************/
		addStep("Validar que se realizó  el envío del archivo REC  por la interfaz PR23  en el directorio de archivos REC en RMS");
	...
	public String setTestFullName() {
		return "ATC_FT_PR_23_002_TransaccionExitosaPagoMercadoLibre";
	}

	@Override
	public String setTestDescription() {
		return "Construido. ATM-FT-008-Validar ejecución de interface FEMSA_PR23 (proceso NB_FEMRCFIDNLD)";
	}
