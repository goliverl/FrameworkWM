...
public class Ro8_Chl_Compras extends BaseExecution {
	@Test(dataProvider = "data-provider")
	public void ATC_FT_RO8_Chl_002_Compras(HashMap<String, String> data) throws Exception {
...
//		Paso 1	**********************************************	
		...
		SQLResult result = executeQuery(dbPuserChile, tdcQueryPaso1);
...
//Paso 2	**********************************************	
		...
		SQLResult result2 = executeQuery(dbRmsChile, tdcQueryPaso2);
...
//Paso 5 *********************************
		...
		SQLResult result10 = executeQuery(dbEbsChile, FormatoPaso7);
...
////	Paso 9  *************************************************
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return " Verificar proceso de interface COMPRAS ";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_RO8_Chl_002_Compras";
	}
