...
public class Ro8_Chl_Ajustes extends BaseExecution { 
    @Test(dataProvider = "data-provider")
	public void ATC_FT_001_RO8_Chl_Ajustes(HashMap<String, String> data) throws Exception {
		...
		SQLResult resultQueryPaso1 = executeQuery(dbPuserChile, tdcQueryPaso1);
		...
		SQLResult resultQueryPaso2 = executeQuery(dbRmsChile, tdcQueryPaso2);
...
//		assertFalse(ValPaso2, "No existe información pendiente de procesar");
		...
		pok1.runIntefaceWmOneButton10(data.get("interfase"), data.get("servicio"));
		...
		SQLResult resultQueryPaso4 = executeQuery(dbLogChile, tdcQueryPaso4);
		...
		SQLResult resultQueryPaso4_1 = executeQuery(dbLogChile, FormatoPaso4_1);
		...
		SQLResult resultQueryPaso5 = executeQuery(dbRmsChile, FormatoPaso5);
		...
		SQLResult resultQueryPaso6 = executeQuery(dbRmsChile, FormatoPaso6);
...
//		assertFalse(ValPaso6, "No se actualizaron los campos REFERENCE_3 y REFERENCE_9.");
		...
		SQLResult resultQueryPaso7 = executeQuery(dbEbsChile, FormatoPaso7);
		...
		SQLResult resultPaso9 = executeQuery(dbRmsChile, FormatoPaso9);
	...
	public String setTestFullName() {
		return "ATC_FT_001_RO8_Chl_Ajustes";
	}
