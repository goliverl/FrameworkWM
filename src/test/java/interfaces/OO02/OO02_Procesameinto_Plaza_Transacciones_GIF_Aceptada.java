...
public class OO02_Procesameinto_Plaza_Transacciones_GIF_Aceptada extends BaseExecution {	

	@Test(dataProvider = "data-provider")
	public void ATC_FT_007_OO02_Procesameinto_Plaza_Transacciones_GIF_Aceptada_test(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/
		...
		String tdcQry3 = " SELECT ENTITY WM_CODE FROM tperep.gif_transaction "
				+ " WHERE folio = %s \r\n"
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
		...
		addStep("Validar que existen datos para procesar en la tabla XXFC_SERVICIOS_LINEA de ORAFIN con estatus 'N' para la plaza.");
		...
		String FormatotdcQry4 = String.format(tdcQry4, clave);
		...
		String FormatotdcQry7 = String.format(tdcQry7, tienda,folio,item,descripcion);
	...
	public String setTestFullName() {
		...
		return "Procesamiento para la Plaza, transacciones GIF -Aceptada";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Verificar procesamiento de la interfaz para la plaza 10APO con transacciones GIF, transacción ACEPTADA.";
	}
