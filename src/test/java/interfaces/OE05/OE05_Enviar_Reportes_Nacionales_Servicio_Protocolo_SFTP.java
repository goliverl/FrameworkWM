...
public class OE05_Enviar_Reportes_Nacionales_Servicio_Protocolo_SFTP extends BaseExecution{
	 

		@Test(dataProvider = "data-provider")
		public void ATC_FT_OE05_003_Enviar_Reportes_Nacionales_Servicio_Protocolo_SFTP(HashMap<String, String> data) throws Exception {
			...
			String TdcQueryPaso2 = " SELECT DISTINCT A.ps_forma_pago_id, A.fecha_administrativa,  A.servicio seviceId, b.service_type servicetype, \r\n"
					+ " b.cr_plaza plaza, A.estatus \r\n"
					+ " FROM XXFC_PAGO_SERVICIO_FORMAS_STG A, XXFC_SERV_VENDOR_COMM_DATA_V b \\n"
					+ " WHERE A.ESTATUS ='I' \r\n"
			...
			String TdcQueryPaso5 = "SELECT * FROM xxfc_lotes \r\n"
					+ " WHERE servicio = %s \r\n"
			...
			String TdcQueryPaso9 = " SELECT b.SERVICE_TYPE serviceType, b.OUTPUT_FORMAT_ID outputFormatId, b.PROTOCOL protocol, b.ATTRIBUTE1 ipFTP, \r\n"
					+ " b.ATTRIBUTE2 portFTP, b.ATTRIBUTE3 userFTP, b.ATTRIBUTE4 passFTP, b.ATTRIBUTE5 pathFTP, b.ATTRIBUTE6 emailSupplier, \r\n"
					+ " b.ATTRIBUTE7 emailUser, hp.PARTY_NAME vendorDesc, b.VENDOR_ID vendorId, b.LEGACY_ID legacyId, b.SERVICE_ID serviceId \r\n"
					+ " FROM XXFC_SERV_VENDOR_COMM_DATA_V b, ap_suppliers pav, hz_parties hp \r\n"
					+ " WHERE pav.party_id = hp.party_id AND b.vendor_id = pav.vendor_id(+) \r\n"
					+ " AND SERVICE_ID = %s \r\n";
			...
			addStep("Validar que existan reportes de servicios Nacionales pendientes de enviar para el protocolo SFTP, mayor o igual a 30 días de antigüedad.\r\n");
			...
			addStep("Validar la carga del archivo en el servidor FTP del proveedor.");
		...
		public String setTestDescription() {
			// TODO Auto-generated method stub
			return "Construido. Enviar los reportes Nacionales de los servicios con protocolo SFTP";
		}
		...
		public String setTestFullName() {
			// TODO Auto-generated method stub
			return "ATC_FT_OE05_003_Enviar_Reportes_Nacionales_Servicio_Protocolo_SFTP";
		}
