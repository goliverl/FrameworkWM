...
public class OE05_Reenviar_Reportes_Locales_Servicio_Finalizar_Estatus_F_Protocolo_FTP extends BaseExecution{
	 

		@Test(dataProvider = "data-provider")
		public void ATC_FT_OE05_005_Reenviar_Reportes_Locales_Servicio_Finalizar_Estatus_F_Protocolo_FTP(HashMap<String, String> data) throws Exception {
			...
			String TdcQueryPaso5 = " SELECT b.SERVICE_TYPE serviceType, b.OUTPUT_FORMAT_ID outputFormatId, b.PROTOCOL protocol, b.ATTRIBUTE1 ipFTP, \r\n"
					...
					+ " AND SERVICE_ID =[XXFC_PAGO_SERVICIO_FORMAS_STG.SERVICIO] \r\n";
					
					
			String TdcQueryPaso7 = "SELECT * FROM WM_OE05_OUTBOUND_DOCS \r\n"
					+ " WHERE service_type= 'L' \r\n"
					+ " AND item = [WM_OE05_OUTBOUND_DOCS.id_del_servicio] \r\n"
					+ " AND ESTATUS ='E' \r\n"
			...
			addStep("Validar que el exista al menos un servicio y lote de tipo Nacional enviado con estatos fallido (F) y protocolo FTP.\r\n");
		...
		public String setTestDescription() {
			// TODO Auto-generated method stub
			return "Construido. Reenviar reportes Nacionales de los servicios que finalizar con estatus F con protocolo FTP";
		}
		...
		public String setTestFullName() {
			// TODO Auto-generated method stub
			return "ATC_FT_OE05_005_Reenviar_Reportes_Locales_Servicio_Finalizar_Estatus_F_Protocolo_FTP";
		}
