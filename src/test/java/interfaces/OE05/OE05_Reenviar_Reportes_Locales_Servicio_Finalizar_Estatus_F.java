...
public class OE05_Reenviar_Reportes_Locales_Servicio_Finalizar_Estatus_F  extends BaseExecution{
	 

		@Test(dataProvider = "data-provider")
		public void ATC_FT_OE05_007_Reenviar_Reportes_Locales_Servicio_Finalizar_Estatus_F(HashMap<String, String> data) throws Exception {
			...
			String TdcQueryPaso2 = "SELECT * FROM WM_OE05_OUTBOUND_DOCS WHERE estatus='F' AND service_type= 'L'\r\n";
			
			String TdcQueryPaso4 = "SELECT * FROM wm_log_run \r\n"
					+ " WHERE interface = 'OE05 - Reenvio' and status= 'S' \r\n"
					+ " and start_dt >= trunc(sysdate) \r\n"
					+ " ORDER BY start_dt DESC \r\n";
					
			String TdcQueryPaso5 = "SELECT b.ATTRIBUTE6 emailSupplier \r\n"
					+ " FROM XXFC_SERV_VENDOR_COMM_DATA_V b, ap_suppliers pav, hz_parties hp WHERE pav.party_id = hp.party_id AND b.vendor_id = pav.vendor_id(+) \r\n"
					+ " AND SERVICE_ID = %s\r\n";
			...
			addStep("Validar que el exista al menos un servicio y lote de tipo Local enviado con estatos fallido (F).\r\n");
		...
		public String setTestDescription() {
			// TODO Auto-generated method stub
			return "Construido. Reenviar reportes Locales de los servicios que finalizar con estatus F";
		}
		...
		public String setTestFullName() {
			// TODO Auto-generated method stub
			return "ATC_FT_OE05_007_Reenviar_Reportes_Locales_Servicio_Finalizar_Estatus_F";
		}
