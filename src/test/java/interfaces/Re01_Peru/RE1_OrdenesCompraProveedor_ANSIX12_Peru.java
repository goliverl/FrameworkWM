...
public class RE1_OrdenesCompraProveedor_ANSIX12_Peru extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_REO1_PERU_001_Ordenes_Compra_ANSIX12(HashMap<String, String> data) throws Exception {
		...
		String registroDoc = "SELECT doc_name, doc_type, edi_control, supplier, status, run_id \r\n "
				+ " FROM WMUSER.edi_outbound_docs " + " WHERE status = 'E' "
...
//*************************************************Paso 2***********************************************************************************************************************
		...
		System.out.println(GlobalVariables.DB_HOST_Oiwmqa);// Pos

		String ordenesPlaza_f = String.format(ordenesPlaza, id);

		System.out.println(ordenesPlaza_f);

		SQLResult ordenesPlaza_r = dbPuserPeru.executeQuery(ordenesPlaza_f);
		...
		assertFalse("No se muestra la configuración del Supplier con la Plaza a la que puede enviar información.",
				validaOrdenesPlaza);
...
//*****************************************Paso 9*****************************************************************************************************************
	...
	public String setTestFullName() {
		...
		return " ATC_FT_REO1_PERU_001_Ordenes_Compra_ANSIX12";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Envío de órdenes de compra a proveedores ANSIX12";
	}
