...
public class Validaproceso_decopia_456_Portaldeproveedores extends BaseExecution {

	private String validarRPY;

	@Test(dataProvider = "data-provider")
	public void ATC_FT_001_rp06_Validaproceso_decopia_456_Portaldeproveedores(HashMap<String, String> data)
			throws Exception {
		//SQLUtil db = new SQLUtil(GlobalVariables.DB_HOST, GlobalVariables.DB_USER,
	...
	public String setTestFullName() {
		return "ATC_FT_001_rp06_Validaproceso_decopia_456_Portaldeproveedores";
	}
