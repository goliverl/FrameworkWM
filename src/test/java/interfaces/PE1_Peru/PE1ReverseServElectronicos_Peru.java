...
public class PE1ReverseServElectronicos_Peru extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_004_PE01_Peru_Reverse_Serv_Electronicos(HashMap<String, String> data) throws Exception {
// Utilerías *********************************************************************
		...
		//utils.sql.SQLUtil dbFCTAEQA = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_FCTAEQA,
			//	GlobalVariables.DB_USER_FCTAEQA, GlobalVariables.DB_PASSWORD_FCTAEQA);
		...
		//SQLUtil dbFCSWQA = new SQLUtil(GlobalVariables.DB_HOST_FCSWPRD_CRECI, GlobalVariables.DB_USER_FCSWPRD_CRECI,
...
//Consultas de codigos
		...
		testCase.setPrerequisites(
				"Contar con número de celular válido para realizar la recarga de tiempo aire.                     "
...
// Paso 1 ************************************************************************************
		...
		folio = getSimpleDataXml(respuesta, "folio");// Se obtienen los datos folio y wm_code del xml de respuesta y se
														// agregan a la evidencia
...
//Paso 2  ************************************************************************************
		...
		String respuestaAuth = pe1Util.ejecutarRunGetAuth(folio);// Se obtienen los datos folio y wm_code del xml de
																	// respuesta y se agregan a la evidencia
...
//********************************************Consulta en la tabla TAE_TRANSACTION:***********************************************************************************
		...
		SQLResult TAE_TRANSACTIONRes1 = db.executeQuery(TAE_TRANSACTION1);
		SQLResult TAE_TRANSACTIONRes2 = db.executeQuery(TAE_TRANSACTION2);
		...
		if (!TAE_TRANSACTIONBool) {
			...
			testCase.addQueryEvidenceCurrentStep(TAE_TRANSACTIONRes1, false); // Si no esta vacio, lo agrega a la
																				// evidencia
...
//*********************************************************Consulta en TAE_REVERSE********************************************************************************
		...
		System.out.println(
				"Paso 6: Ejecutar  query en la tabla TAE_REVERSE para validar que se reversó exitosamente la transacción:");

		// folio = "5596596529";
		String TAE_REVERSE1 = String.format(query_TAE_REVERSE1, folio);
		SQLResult TAE_REVERSERes1 = db.executeQuery(TAE_REVERSE1);
		...
		if (!TAE_REVERSE1Bool1) {
			...
			testCase.addBoldTextEvidenceCurrentStep("Resultado Esperado:");
			testCase.addBoldTextEvidenceCurrentStep(
					"Se ejecuta la consulta y se muestra el reverso de la transacción de forma exitosa.");
...
//********************************************************Consulta query_TPE_SW_TLOG1*******************************************************************
		...
		SQLResult result3 = executeQuery(db, tempTPEQuery);
		SQLResult result3P2 = executeQuery(db, tempTPEQuery2);
		SQLResult result3P3 = executeQuery(db, tempTPEQuery3);
		...
		if (!validationTPE) {
			...
			SQLResult resultQRO2 = executeQuery(db, tempTPEQuery2);
			SQLResult resultQRO3 = executeQuery(db, tempTPEQuery3);
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Realizar una recarga no exitosa aplicando el reverso. "
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_004_PE01_Peru_Reverse_Serv_Electronicos";
	}
