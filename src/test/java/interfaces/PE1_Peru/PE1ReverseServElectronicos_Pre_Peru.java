...
public class PE1ReverseServElectronicos_Pre_Peru extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_005_PE01_Peru_Reverse_Serv_Electronicos_Prerequisitos(HashMap<String, String> data) throws Exception {
		...
		String query_TAE_REVERSE1 = " SELECT folio, creation_date, plaza, tienda, phone, carrier, sw_auth, wm_code, retek_cr "
				...
				+ " WHERE CREATION_DATE >=  TO_CHAR(SYSDATE,'WW-MON-YY') "
				+ " AND FOLIO='%s' "
				+ " ORDER BY CREATION_DATE DESC ";
		...
		String query_TPE_SW_TLOG1 = "select plaza, tienda, caja, retek_cr, channel, application, entity, folio, creation_date "
				+ " from SWUSER.TPE_SW_TLOG where TIENDA='" + data.get("tienda")
				+ "' and APPLICATION='TAE' "
...
//*****************************************************Prerequisitos************************************************************************************************************		
		...
		pe1Util.validaCarrier(db);

		// Validar que la tienda cuente con ese carrier

		pe1Util.validaConfigTienda(db);
...
// Paso 1  *******************************************************************************
		...
		// testCase.addTextEvidenceCurrentStep("Folio: "+ folio);//Se agrega a la
		// evidencia el folio
...
//Paso 5  *******************************************************************************
		...
		wmCodeRes = executeQuery(db, wm_code);
...
//********************************************************Consulta query_TPE_SW_TLOG1*******************************************************************					    
		...
		SQLResult TPE_SW_TLOG_Res1 = db.executeQuery(query_TPE_SW_TLOG1);
	...
	public String setTestFullName() {
		return "ATC_FT_005_PE01_Peru_Reverse_Serv_Electronicos_Prerequisitos";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Validar Switch_Transacción no exitosa TAE Reversa timeOut";
	}
