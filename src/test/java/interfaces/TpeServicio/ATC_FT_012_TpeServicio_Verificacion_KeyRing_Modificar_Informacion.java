...
public class ATC_FT_012_TpeServicio_Verificacion_KeyRing_Modificar_Informacion extends BaseExecution{
	
	/*
	 * 
	 * @cp Verificar KeyRing MODIFICAR informacion
	 * 
	 */
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_012_TpeServicio_Verificacion_KeyRing_Modificar_Informacion_test (HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/	
		...
		String WmCode = pok.runIntefaceWmWithcuatroInputxml(data.get("interfase"), data.get("servicio"),
				data.get("folio"), data.get("Folio"), data.get("Plaza"), data.get("plaza"), data.get("Tienda"),
				data.get("tienda"), data.get("Phone"), data.get("telefono"));
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Verificar KeyRing MODIFICAR informacion";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_012_TpeServicio_Verificacion_KeyRing_Modificar_Informacion_test";
	}
