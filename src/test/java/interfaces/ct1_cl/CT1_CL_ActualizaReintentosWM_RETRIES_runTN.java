...
public class CT1_CL_ActualizaReintentosWM_RETRIES_runTN extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_003_CT1_CL_Verificar_procesamiento_actualizar_WM_RETRIES_runTN(HashMap<String, String> data) throws Exception {
		...
		// UPDATE
		String UpdateRetriesBuzon = "UPDATE WM_BUZONES_T_TIENDAS " + "SET WM_RETRIES  = 1 WHERE ID = '%s'";
...
//						     "AND TRUNC(WM_FECHA_PROC) = TRUNC(SYSDATE)";
		...
		String validaRetries = "SELECT ID,CR_PLAZA, CR_TIENDA, WM_STATUS , WM_RETRIES " + "FROM WM_BUZONES_T_TIENDAS "
				+ "WHERE WM_RETRIES = 2 " + "AND CR_PLAZA = '" + data.get("plaza") + "' " + "AND CR_TIENDA = '"
				+ data.get("tienda") + "' ";
...
//********************************************Paso2 y 3*****************************************************************************
		...
		addStep("Verificar que existan la plaza y la tienda en la tabla WM_BUZONES_T_TIENDAS con WM_STATUS = 'L' y  WM_RETRIES = 1.");
...
//			En caso de que el WM_RETRIES sea diferente a 1 puede actualizarse el campo para la ejecuci�n del caso.
...
//**************************************************Paso 7 ***************************************************************************		
		...
		addStep("Validar que el  WM_RETRIES de la tabla WM_BUZONES_T_TIENDAS fue actualizado a  WM_RETRIES = 2;");
		...
		String RetrieBuzon = validaRetriesR.getData(0, "WM_RETRIES");
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_003_CT1_CL_Verificar_procesamiento_actualizar_WM_RETRIES_runTN";
	}
