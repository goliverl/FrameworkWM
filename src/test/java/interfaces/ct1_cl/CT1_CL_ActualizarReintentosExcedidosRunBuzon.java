...
public class CT1_CL_ActualizarReintentosExcedidosRunBuzon extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_001_CT1_CL_Verificar_procesamiento_actualizar_runBuzon(HashMap<String, String> data) throws Exception {
		...
		// UPDATE
		String UpdateRetriesBuzon = "UPDATE WM_BUZONES_T_TIENDAS " + "SET WM_RETRIES_BUZON = 2  WHERE ID = '%s'";
...
//			
		...
		// Usar esta para pruebas sin ejecutar servicio (RunBuzon)
		String validaStatusBuz = "SELECT ID,CR_PLAZA, CR_TIENDA, WM_STATUS_BUZON , WM_RETRIES_BUZON "
				+ "FROM WM_BUZONES_T_TIENDAS " + "WHERE WM_STATUS_BUZON = 'M'  " + "AND CR_PLAZA = '"
				+ data.get("plaza") + "' " + "AND CR_TIENDA = '" + data.get("tienda") + "' ";
...
//**********************************************Paso 1	****************************************************************************
//				Verificar que el directorio existe en el filesystem corresppondiente a chile
...
//********************************************Paso2 y 3*****************************************************************************
		...
		if (!validaStatusL) {
			...
			// En caso de que el WM_RETRIES_BUZON sea menor a 2 puede actualizarse el campo
			// para la ejecuci�n del caso.
			// AL MOMENTO NO SE PUEDEN REALIZAR LOS UPDATES
...
//********************Paso 8 ************************************************************************************************		
		...
		SQLResult validaRetriesR = executeQuery(dbCNTCL, validaStatusBuz);
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_001_CT1_CL_Verificar_procesamiento_actualizar_runBuzon";
	}
