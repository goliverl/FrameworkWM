...
public class BTC_insertarTransaccionQRY02Json extends BaseExecution{

	@Test(dataProvider = "data-provider")
	public void ATC_FT_004_TPE_BTC_Insertar_Transaccion_QRY02_Json(HashMap<String, String> data) throws Exception {
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
	...
	public String setTestFullName() {
		return "ATC_FT_004_TPE_BTC_Insertar_Transaccion_QRY02_Json";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Realizar la ejecucion del json con la operación QRY02 para insertar una transaccion exitosa";
	}
