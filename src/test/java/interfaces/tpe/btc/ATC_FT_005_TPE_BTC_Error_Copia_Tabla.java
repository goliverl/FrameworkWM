...
public class ATC_FT_005_TPE_BTC_Error_Copia_Tabla extends BaseExecution{

	@Test(dataProvider = "data-provider")
	public void ATC_FT_005_TPE_BTC_Error_Copia_Tabla_Test(HashMap<String, String> data) throws Exception {
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
		...
		addStep("Validar que ya no exista la tabla " + data.get("tabla"));
		...
		addStep("Validar el mensaje de error en la tabla TPEREP.TPE_TABLAS_COPIA.");
	...
	public String setTestFullName() {
		return "ATC_FT_005_TPE_BTC_Error_Copia_Tabla";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Validar el error en el copiado de una tabla de la BD FCTPEQA hacia la BD TPEREPQA al no existir la tabla en BD TPEREPQA";
	}
