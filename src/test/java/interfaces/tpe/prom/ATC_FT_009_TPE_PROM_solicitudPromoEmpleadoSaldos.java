...
public class ATC_FT_009_TPE_PROM_solicitudPromoEmpleadoSaldos extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_009_TPE_PROM_solicitudPromoEmpleadoSaldos_test(HashMap<String, String> data) throws Exception {
...
//paso 2 *********************
		...
		String contra = "\r\n"+ "http://10.184.40.109:8894/invoke/TPE.PROM.Pub:request?xmlIn=" + user + ":" + ps + "@" + server + ":5555";
...
//paso 4****************************
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Validar el retorno del codigo de respuesta 009 y 010 de una Solicitud de Redencion de promocion QRY01";
	}
