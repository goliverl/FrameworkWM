...
public class FCPUpd02Tae extends BaseExecution{
	
	/*
	 * 
	 * @cp TAE_Realizar la actualizacion de los datos frecuentes de clientes(telefonos de TAE)
	 * 
	 */
	
		@Test(dataProvider = "data-provider")
		public void ATC_FT_TPE_FCP_009_Upd02Tae(HashMap<String, String> data) throws Exception {
...
//			SqlUtil db = new SqlUtil(GlobalVariables.DB_USERPE3, GlobalVariables.DB_PASSWORDPE3, GlobalVariables.DB_HOSTPE3);
			...
			String queryValidation01 = "SELECT CODE,ACCOUNT_ID,STATUS,DESCRIPTION,CREATION_DATE,ACTUALIZATION_DATE "
					...
					+ "WHERE APPLICATION = 'FCP' AND ENTITY = 'TAE' AND CATEGORY = 'TAE_LIST' AND CODE = '%s'";
			...
			String queryValidation02 = "SELECT OPERATION,FOLIO,CREATION_DATE,PLAZA,TIENDA,WM_CODE,WM_DESC "
					...
					+ "WHERE APPLICATION = 'FCP' AND ENTITY = 'TAE' AND OPERATION = 'OPR01' AND FOLIO = %s";
			...
			String queryValidation03 = "SELECT CODE,ACCOUNT_ID,STATUS,DESCRIPTION,VALUE1,VALUE2,CREATION_DATE,ACTUALIZATION_DATE "
	 		...
	 		String folio;
			String wmCodeRequestTRN01; // wmCodeDbTRN01; //dateDbTRN01;
			...
			String query03 = String.format(queryValidation03,data.get("code"));// 7355424106
			...
			//try {//indexOutOfBoundsException
			     ...
			     String dateDbTRN01 = result.getData(0, "ACTUALIZATION_DATE"); //obtener fecha de actualizacion en la bd
		...
		public String setTestDescription() {
			// TODO Auto-generated method stub
			return "Realizar la actualizacion de los datos frecuentes de clientes(telefonos de TAE)";
		}
		...
		public String setTestFullName() {
			return "ATC_FT_TPE_FCP_009_Upd02Tae";
		}
