...
public class ATC_FT_023_TPE_COPIA_PrimeraEjecucionJobRespaldoInfoTPE_FR_TRANSACTION_sinDepuracion extends BaseExecution {
	...
	public void ATC_FT_023_TPE_COPIA_PrimeraEjecucionJobRespaldoInfoTPE_FR_TRANSACTION_sinDepuracion_test(HashMap<String, String> data) throws Exception {
		 ...
		 * Caso de prueba: MTC-FT-023 TPE_COPIA Primera ejecución del job de respaldo de información de premia de la tabla TPE_FR_TRANSACTION sin depuración
...
//***************************************** Paso 14 *****************************************************************
		...
		assertFalse(validaConsultaTotalReg, "No existe información pendiente de procesar en la tabla.");
...
//***************************************** Paso 18 *****************************************************************
	...
	public String setTestDescription() {
		...
		return "Prueba de regresión para comprobar la no afectación en la funcionalidad de "
				+ "Primera ejecución del job de respaldo de información de de premia de la "
				+ "tabla TPE_FR_TRANSACTION sin depuración del proceso de TPE_COPIA ";
	}
