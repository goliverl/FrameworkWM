...
public class OE06_Validar_Procesameinto_Flujo_Normal_Envio_Documentos_CEN extends BaseExecution {
...
//Paso 5	************************
		...
		String FormatoPaso5 = String.format(id, Parentid,tdcQueryPaso5);
...
//Paso 7	************************
	...
	public String setTestFullName() {
		...
		return "Validar el Procesamiento del Flujo normal de envio de documentos CEN";
	}
