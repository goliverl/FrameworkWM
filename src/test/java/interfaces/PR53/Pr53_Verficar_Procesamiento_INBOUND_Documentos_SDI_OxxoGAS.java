...
public class Pr53_Verficar_Procesamiento_INBOUND_Documentos_SDI_OxxoGAS extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_PR53_009_Verificar_INBOUND_Docs_SDI_OxxoGAS(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/	
		...
		String tdcPaso2 =	"SELECT * FROM GAS_SDI_OG  \r\n"
				+ "WHERE gid_id = %s";
			
		String tdcPaso2_1=	"SELECT * FROM GAS_SDI_DETL_OG\r\n"
				+ "WHERE GID_ID = %s";
		...
		String tdcPaso6 = "SELECT * FROM GAS_SDI \r\n"
				+ "WHERE GID_ID = %s \r\n";
				
		String tdcPaso6_1 = "SELECT * FROM GAS_SDI_DETL \r\n"
				+ "WHERE GID_ID = %s";
		...
		addStep(" Verificar que se inserten los datos en GAS_SDI Y GAS_SDI_DETL \r\n ");
...
//PAso 3 ************************************************************************************************************************************					
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Que la interface termine satisfactoriamente y que la información sea procesada y que se inserte la información en las tablas GAS_INBOUND_DOCS, GAS_SDI y GAS_SDI_DETL. "
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PR53_009_Verificar_INBOUND_Docs_SDI_OxxoGAS";
	}
