...
public class Pr53_Verficar_Procesamiento_INBOUND_Documentos_RTV_OxxoGAS extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_PR53_007_Verificar_INBOUND_Docs_RTV_OxxoGAS(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/	
		...
		String tdcPaso2 =	" SELECT * FROM GAS_RTV_OG \r\n"
				+ " WHERE GID_ID = %s \r\n";
			
		String tdcPaso2_1 =	" SELECT * FROM GAS_RTV_DETL_OG \r\n"
				+ " WHERE GID_ID = %s \r\n";
		...
		String tdcPaso4_1= " SELECT * FROM GAS_INBOUND_DOCS \r\n"
				+ " WHERE pv_doc_id = %s \r\n"
				+ " AND doc_type ='GTD' \r\n"
				+ " AND status = 'I' \r\n"
				+ " AND target_id = %s \r\n"
		...
		String tdcPaso6 = " SELECT * FROM GAS_RTV\r\n"
				+ " WHERE GID_ID= %s \r\n";
				
		String tdcPaso6_1 = " SELECT * FROM GAS_RTV_DETL\r\n"
				+ " WHERE GID_ID= %s\r\n" ;
		...
		addStep("Debe de haber datos en la tabla  GAS_RTV_OG y GAS_RTV_DETL_OG\r\n");
       ...
       // Paso 3 ************************************************************************************************************************************					
		...
		addStep("Verificar que se inserten los datos en GAS_RTV Y GAS_RTV_DETL");
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Que la interface termine satisfactoriamente y que la información sea procesada y que se inserte la información en las tablas GAS_INBOUND_DOCS, GAS_RTV y GAS_RTV_DETL. "
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PR53_007_Verificar_INBOUND_Docs_RTV_OxxoGAS";
	}
