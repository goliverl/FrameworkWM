...
public class Pr53_Verficar_Procesamiento_INBOUND_Documentos_TPE_POS extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_PR53_010_Verificar_INBOUND_Docs_TPE_POS(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/	
		...
		String tdcPaso2 = " SELECT * FROM GAS_TPE_OG\r\n"
				+ " WHERE GID_ID = %s \r\n";
		
		String tdcPaso2_1 =	"SELECT * FROM GAS_TPE_DETL_OG\r\n"
				+ "WHERE GID_ID = %s";
		...
		String tdcPaso7 = "SELECT * FROM POS_TPE\r\n"
				+ "WHERE PID_ID= %s";
		
		String tdcPaso7_1 =  "SELECT * FROM POS_TPE_DETL\r\n"
				+ "WHERE PID_ID= %s\r\n";
		...
		addStep("Tener registros en la tabla GAS_INBOUND_DOCS_OG de tipo TPE en status L, R o W.\r\n");
		...
		if (!ValPaso1) {
			...
			PvDocName = Paso1.getData(0, "PV_DOC_NAME");
		...
		addStep("Tener el detalle del documento GAS_TPE_OG y GAS_TPE_DETL_OG\r\n");
...
//PAso 3 ************************************************************************************************************************************					
		...
		String FormatoPaso5 = String.format(tdcPaso5, PvDocName, PvDocName, id);
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Que la interface termine satisfactoriamente y que la información sea procesada y que se inserte la información en las tablas POS_ENVELOPE, POS_INBOUND_DOCS, POS_TPE y POS_TPE_DETL. "
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PR53_010_Verificar_INBOUND_Docs_TPE_POS";
	}
