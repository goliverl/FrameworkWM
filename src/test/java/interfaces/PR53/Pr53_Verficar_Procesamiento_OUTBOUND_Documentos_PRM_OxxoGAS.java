...
public class Pr53_Verficar_Procesamiento_OUTBOUND_Documentos_PRM_OxxoGAS extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_PR53_018_Verificar_OUTBOUND_Docs_PRM_OxxoGAS(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/	
		...
		String tdcPaso2_1 =	"SELECT * FROM GAS_PMC_DETALLE \r\n"
				+ "WHERE GOD_ID = %S \r\n";
		...
		String tdcPaso6 = "SELECT * FROM GAS_HEADER_PROM_OG \r\n"
				+ "WHERE GOD_ID = %s";
		
		String tdcPaso6_1 = "SELECT * FROM GAS_DETAIL_PROM_OG\r\n"
				+ "WHERE GOD_ID = %s";
		...
		addStep("Tener registros en la tabla Gas_OutBound_Docs del tipo de documento PRM con status L,W,R o X");
		...
		addStep("Tener el detalle del documento GAS_HEADER_PROM y GAS_DETAIL_PROM ");
...
//PAso 3 ************************************************************************************************************************************					
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Que la interface termine satisfactoriamente y que la información sea procesada y que se inserte la información en las tablas GAS_HEADER_PROM_OG y GAS_DETAIL_PROM_OG. "
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PR53_018_Verificar_OUTBOUND_Docs_PRM_OxxoGAS";
	}
