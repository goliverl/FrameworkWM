...
public class Pr53_Verficar_Procesamiento_OUTBOUND_Documentos_TSC_OxxoGAS extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_PR53_019_Verificar_OUTBOUND_Docs_TSC_OxxoGAS(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/	
		...
		String tdcPaso2 =	" SELECT * FROM GR8_HEADER_ORDERLINE \r\n"
				+ " WHERE GOD_ID = %s \r\n";
				 
		
		String tdcPaso2_1 =	" SELECT * FROM GR8_DETAIL_ORDERLINE\r\n"
				+ " WHERE GOD_ID = %s \r\n";
		...
		String tdcPaso6 = " SELECT * FROM GR8_HEADER_ORDERlINE_OG \r\n"
				+ " WHERE GOD_ID = %s \r\n";
				
	   String tdcPaso6_1 = " SELECT * FROM GR8_DETAIL_ORDERLINE_OG\r\n"
	   		+ " WHERE GOD_ID = %s\r\n";
		...
		addStep("Tener registros en la tabla Gas_OutBound_Docs del tipo de documento TSC con status L,W,R o X");
		...
		addStep("Tener el detalle del documento GR8_HEADER_ORDERLINE y GR8_DETAIL_ORDERLINE");
...
//PAso 3 ************************************************************************************************************************************					
		...
		addStep("Verificar que se inserten registros en la tabla GR8_HEADER_ORDERlINE_OG y GR8_DETAIL_ORDERLINE_OG");
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Que la interface termine satisfactoriamente y que la información sea procesada y que se inserte la información en las tablas GR8_HEADER_ORDERlINE_OG y GR8_DETAIL_ORDERLINE_OG. "
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PR53_019_Verificar_OUTBOUND_Docs_TSC_OxxoGAS";
	}
