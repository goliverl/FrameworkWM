...
public class Pr53_Verficar_Procesamiento_INBOUND_Documentos_TSF_OxxoGAS extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_PR53_011_Verificar_INBOUND_Docs_TSF_OxxoGAS(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/	
		...
		String tdcPaso2 =	" SELECT * FROM GAS_TSF_OG \r\n"
				+ "WHERE GID_ID = %s \r\n" ;
		
		String tdcPaso2_1 =	" SELECT * FROM GAS_TSF_DETL_OG \r\n"
				+ "WHERE GID_ID = %s \r\n";
		...
		String tdcPaso6 = " SELECT * FROM GAS_TSF \r\n"
				+ " WHERE PID_ID= %s \r\n";
		
		String tdcPaso6_1 = " SELECT * FROM GAS_TSF_DETL \r\n"
				+ " WHERE PID_ID= %s \r\n";
		...
		addStep("Tener registros en la tabla GAS_INBOUND_DOCS_OG de tipo TSF en status L, R o W.");
		...
		addStep("Debe de haber datos en la tabla  GAS_TSF_OG y GAS_TSF_DETL_OG\r\n");
...
//PAso 3 ************************************************************************************************************************************					
		...
		addStep("Verificar que se inserten los datos en GAS_TSF Y GAS_TSF_DETL \r\n");
		...
		String FormatoPaso7 = String.format(tdcPaso7, runid, id);
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Contruido. Que la interface termine satisfactoriamente y que la información sea procesada y que se inserte la información en las tablas GAS_INBOUND_DOCS, GAS_TSF y GAS_TSF_DETL. "
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PR53_011_Verificar_INBOUND_Docs_TSF_OxxoGAS";
	}
