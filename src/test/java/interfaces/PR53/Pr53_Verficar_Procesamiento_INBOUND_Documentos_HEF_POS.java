...
public class Pr53_Verficar_Procesamiento_INBOUND_Documentos_HEF_POS extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_PR53_004_Verificar_INBOUND_Docs_HEF_POS(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/	
		...
		String tdcPaso2 ="SELECT * FROM GAS_HEF_OG\r\n"
				+ "WHERE GID_ID = %s \r\n";
		
		String tdcPaso2_1 = "SELECT * FROM GAS_HEF_DETL_OG \r\n"
				+ "WHERE GID_ID = %s \r\n";
		...
		String tdcPaso7 = "SELECT * FROM POS_HEF\r\n"
				+ "WHERE PID_ID = %s \r\n";
			   
		
		String tdcPaso7_1 =  "SELECT * FROM POS_HEF_DETL\r\n"
				+ "WHERE PID_ID= %s \r\n";
		...
		addStep("Tener registros en la tabla GAS_INBOUND_DOCS_OG de tipo HEF en status L, R o W.\r\n");
...
//PAso 3 ************************************************************************************************************************************					
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Que la interface termine satisfactoriamente y que la información sea procesada y que se inserte la información en las tablas POS_ENVELOPE, POS_INBOUND_DOCS, POS_HEF y POS_HEF_DETL. "
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PR53_004_Verificar_INBOUND_Docs_HEF_POS";
	}
