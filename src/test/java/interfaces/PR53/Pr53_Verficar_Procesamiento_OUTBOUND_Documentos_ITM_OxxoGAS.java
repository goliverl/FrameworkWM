...
public class Pr53_Verficar_Procesamiento_OUTBOUND_Documentos_ITM_OxxoGAS extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_PR53_016_Verificar_OUTBOUND_Docs_ITM_OxxoGAS(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/	
		...
		String tdcPaso2  =" SELECT * FROM GAS_HEADER_ITM\r\n"
				+ " WHERE GOD_ID = %s";
		
		String tdcPaso2_1 = " SELECT * FROM GAS_DETAIL_ITM\r\n"
				+ " WHERE GOD_ID = %s";
		...
		String tdcPaso6 = " SELECT * FROM GAS_HEADER_ITM_OG \r\n"
				+ " WHERE GOD_ID = %s \r\n";
		
		String tdcPaso6_1 = " SELECT * FROM GAS_DETAIL_ITM_OG\r\n"
				+ " WHERE GOD_ID = %s\r\n";
		...
		addStep("Tener registros en la tabla Gas_OutBound_Docs del tipo de documento ITM con status L,W,R o X \r\n");
		...
		if (!ValPaso1) {
			...
			TargetType = Paso1.getData(0,"TargetType");
		...
		addStep("Tener el detalle del documento GAS_HEADER_ITM y GAS_DETAIL_ITM \r\n");
		...
		addStep("Verificar que se inserten registros en la tabla GAS_HEADER_ITM_OG y GAS_DETAIL_ITM_OG\r\n");
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Que la interface termine satisfactoriamente y que la información sea procesada y que se inserte la información en las tablas GAS_HEADER_ITM_OG y GAS_DETAIL_ITM_OG.\r\n"
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PR53_016_Verificar_OUTBOUND_Docs_ITM_OxxoGAS";
	}
