...
public class Pr53_Verficar_Procesamiento_OUTBOUND_Documentos_EXR_OxxoGAS extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_PR53_013_Verificar_OUTBOUND_Docs_EXR_OxxoGAS(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/	
		...
		String tdcPaso2 =	" SELECT * FROM HEADER_TC \r\n"
				+ " WHERE GOD_ID = %s";
		
		String tdcPaso2_1 = " SELECT * FROM DETAIL_TC \r\n"
				+ " WHERE GOD_ID = %s \r\n";
		...
		String tdcPaso6 = "SELECT * FROM HEADER_TC_OG \r\n"
				+ "WHERE GOD_ID = %s\r\n";
		
		String tdcPaso6_1 = " SELECT * FROM DETAIL_TC_OG\r\n"
				+ " WHERE GOD_ID = %s\r\n";
		...
		addStep("Tener registros en la tabla Gas_OutBound_Docs del tipo de documento EXR con status L,W,R o X\r\n");
		...
		if (!ValPaso1) {
			...
			Targetid = Paso1.getData(0, "Target_Id");
		...
		boolean ValPaso2_1 = Paso2.isEmpty();
...
//PAso 3 ************************************************************************************************************************************					
		...
		String FormatoPaso5 = String.format(tdcPaso5, id, DocType, Targetid, runid);
		...
		addStep("Verificar que se inserten registros en la tabla HEADER_TC_OG y DETAIL_TC_OG");
		...
		System.out.println(GlobalVariables.DB_HOST_FCWMQA_NUEVA);
		System.out.println(tdcPaso7);
		SQLResult Paso7 = dbPos.executeQuery(tdcPaso7);
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Que la interface termine satisfactoriamente y que la información sea procesada y que se inserte la información en las tablas HEADER_TC_OG y DETAIL_TC_OG. "
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PR53_013_Verificar_OUTBOUND_Docs_EXR_OxxoGAS";
	}
