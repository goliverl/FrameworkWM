...
public class Pr53_Verficar_Procesamiento_OUTBOUND_Documentos_FAR_OxxoGAS extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_PR53_014_Verificar_OUTBOUND_Docs_FAR_OxxoGAS(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/	
		...
		String tdcPaso2 =	"Select *  From GAS_FAG "
				+ " where GOD_ID= %s \r\n";
								
		String tdcPaso2_1 = "Select * From GAS_FAG_DETL "
				+ " where GOD_ID= %s \r\n";
		...
		String tdcPaso4_1= " SELECT * from WM_LOG_THREAD\r\n"
				+ " where PARENT_ID = %s\r\n"
				+ " and NAME LIKE 'PR53-O-FAG-%';";
				
		String tdcPaso5 = "	SELECT * FROM GAS_OUTBOUND_DOCS_OG\r\n"
				+ "WHERE POE_ID = [Gas_OutBound_docs.id]\r\n"
				+ "AND STATUS = 'I'\r\n"
				+ "AND DOC_TYPE = [Gas_OutBound_Docs.Doc_Type]\r\n"
				+ "AND TARGET_TYPE = [Gas_OutBound_Docs.Target_Type]\r\n"
				+ "AND SOURCE_ID = [WM_LOG_RUN.RUN_ID]\r\n";
				
		String tdcPaso6 = "SELECT * FROM GAS_FAG_OG \r\n"
				+ "WHERE GOD_ID = [GAS_OUTBOUND_DOCS_OG.ID];\r\n";
				

		String tdcPaso6_1 = "SELECT * FROM GAS_FAG_DETL_OG\r\n"
				+ "WHERE GOD_ID = [GAS_OUTBOUND_DOCS_OG.ID];\r\n";
		...
		String tdcPaso7 = "SELECT id, POE_ID, DOC_TYPE, PV_CR_PLAZA, PV_CR_TIENDA, STATUS, DATE_CREATED, DATE_SENT, SOURCEAPP\r\n"
				...
				+ "where POE_ID=[Gas_OutBound_Docs_OG.Id]\r\n"
				+ "AND Status='P'\r\n"
				+ "AND doc_Type = 'FAG'\r\n"
		...
		addStep("Tener registros en la tabla Gas_OutBound_Docs del tipo de documento FAG con status L,W,R o X\r\n");
...
//PAso 3 ************************************************************************************************************************************					
		...
		addStep("Verificar la ejecución de la interface en WMLOG.\r\n");
		...
		addStep("Verificar que se inserten registros en la tabla GAS_FAG_OG y GAS_FAG_DETL_OG");
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Que la interface termine satisfactoriamente y que la información sea procesada y que se inserte la información en las tablas GAS_FAG_OG y GAS_FAG_DETL_OG. "
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PR53_014_Verificar_OUTBOUND_Docs_FAR_OxxoGAS";
	}
