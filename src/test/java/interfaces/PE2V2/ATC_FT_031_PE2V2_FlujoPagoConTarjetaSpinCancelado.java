...
public class ATC_FT_031_PE2V2_FlujoPagoConTarjetaSpinCancelado extends BaseExecution{

	/**
	 * PE2V2:MTC-FT-031 CP042 Flujo de pago Con Tarjeta Spin cancelado
	 * Desc:
	 * Regresion con XPOS
	 * Realizar un flujo exitoso de pago con Tarjeta Spin y cancelarlo
	 * 
	 * Mtto:
	 * @author Jose Onofre
	 * @date 02/27/2023
	...
	public void ATC_FT_031_PE2V2_FlujoPagoConTarjetaSpinCancelado_test (HashMap<String, String> data) throws Exception {
		/*
		 * Utilerías
		 ************************************************************************/
...
//		************Cancelacion*************************************************
		addStep("Solicitar a XPOS que se realice la devolucion de la compra");
	...
	public String setTestFullName() {
		...
		return "ATC_FT_031_PE2V2_FlujoPagoConTarjetaSpinCancelado_test";
	}
