...
/**
*PE2V2:MTC-FT-054 Transaccion exitosa por WS Provider - Cambio en timestamp
*Desc:
*Validar que el WS del Provider al tener una diferente a la configuracion en el 
*timestamp permita realizar la transaccion ya que la politica nueva no utiliza esta
* funcionalidad de default o configurada
*
...
* @date 02/27/2023
*/
public class ATC_FT_054_PE2V2_TransaccionExitosaWSProviderCambioTimestamp extends BaseExecution{
		@Test (dataProvider = "data-provider")
		public void ATC_FT_054_PE2V2_TransaccionExitosaWSProviderCambioTimestamp_test (HashMap<String, String> data) throws Exception {
			/*
			 * Utilerías
			 ************************************************************************/
...
//			utils.sql.SQLUtil dbFCWMLTAEQA_QRO = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_FCWMLTAEQA_QRO, GlobalVariables.DB_USER_FCWMLTAEQA_QA, GlobalVariables.DB_PASSWORD_FCWMLTAEQA_QRO_QA);
			 ...
			 * - Solicitar apoyo a soporte por medio de ticket donde:
				**Modifique en el webservice del servidor donde se encuentra el Switch **
				1. Ingresando al IS (QA9):
				2. Editar desde *Settings > Web Services > Web Service Provider Endpoints List > WSSecurity_port  *
				3. En el *WS Security Properties* 
				3.1 Timestamp Precision = milisegundos
				3.2 Timestamp Time to Live = 1
				3.3 Timestamp Maximum Skew = 1
			 */
			...
			/*  En los pasos de octane no especifica que requests mandar, se comenta codigo de transaccion normal hasta verificar que sea el mismo proceso
			 - ? Realizar una transacción <tipo_transaccion> , exitosa sobre el site: <Nombre_SITE>
		...
		public String setTestDescription() {
			// TODO Auto-generated method stub
			return "MTC-FT-054 Transaccion exitosa por WS Provider - Cambio en timestamp";
		}
		...
		public String setTestFullName() {
			// TODO Auto-generated method stub
			return "ATC_FT_054_PE2V2_TransaccionExitosaWSProviderCambioTimestamp_test";
		}
