...
public class ATC_FT_033_PE2V2_TransaccionNoExitosaPorWSProviderSinPoliticaConfigurada extends BaseExecution{
	
	/**
	 * PE2V2:MTC-FT-033 Transaccion no exitosa  por WS Provider- sin politica configurada
	 * Desc:
	 * Validar que el WS del Provider al no tener politica configurada no permita realizar la transaccion y lo marque por error de WsSecurity
	 * 
	 * Mtto:
	 * @author Jose Onofre
	 * @date 02/27/2023
	...
	public void ATC_FT_033_PE2V2_TransaccionNoExitosaPorWSProviderSinPoliticaConfigurada_test (HashMap<String, String> data) throws Exception {
		/*
		 * Utilerías
		 ************************************************************************/
...
//		utils.sql.SQLUtil dbFCWMLTAEQA_QRO = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_FCWMLTAEQA_QRO, GlobalVariables.DB_USER_FCWMLTAEQA_QA, GlobalVariables.DB_PASSWORD_FCWMLTAEQA_QRO_QA);
		...
		/*
		Ingresar al paquete del Switch sobre la ruta: FC_OXXO_SWITCH > FC > TPE >SWITCH > WSSecurity
		Eliminar la politica desde la pestaña: Policies 

		Contar con el acelerador criptografico encendido (QA8)
		...
		assertTrue(validateTrans, " se encontro registro de transaccion");
		/******************************************Paso 6*************************************/
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "MTC-FT-033 Transaccion no exitosa  por WS Provider- sin politica configurada";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_033_PE2V2_TransaccionNoExitosaPorWSProviderSinPoliticaConfigurada_test";
	}
