...
public class ATC_FT_044_P2V2_RealReverNoEnvACKTimeoutTBUsaNuevConect extends BaseExecution {

	/**
	 *PE2V2:MTC-FT-044 Realizar reversa por NO enviar ACK (Timeout TB) usando nuevo conector
	 *Desc:
	 *Validar que realice reverso exitoso por no enviar ACK para compra con tarjeta con el nuevo conector. 
	 * 
	 * @author Jose Onofre
	 * 
	 * Mtto:
	...
	public void ATC_FT_044_P2V2_RealReverNoEnvACKTimeoutTBUsaNuevConect_test(HashMap<String, String> data) throws Exception {
		...
		String expected_wm_code = "111";
		String expected_reversed = "01";
	...
	public String setTestFullName() {
		return "ATC_FT_044_P2V2_RealReverNoEnvACKTimeoutTBUsaNuevConect_test";
	}
