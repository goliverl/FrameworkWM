...
/**
*
* PE2V2:MTC-FT-018 Realizar reversa de compra por ACK negativo usando conector nuevo
* Desc:
* Validar que realice reverso exitoso por ACK negativo para compra con tarjeta con el nuevo conector.
* 
...
public class ATC_FT_018_PE2V2_RealizarReversaCompraPorACKNegativoConectorNuevo extends BaseExecution{

	@Test (dataProvider = "data-provider")
	public void ATC_FT_018_PE2V2_RealizarReversaCompraPorACKNegativoConectorNuevo_test (HashMap<String, String> data) throws Exception {
		/*
		 * Utilerías
		 ************************************************************************/
...
//		utils.sql.SQLUtil dbFCWMLTAEQA_QRO = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_FCWMLTAEQA_QRO, GlobalVariables.DB_USER_FCWMLTAEQA_QA, GlobalVariables.DB_PASSWORD_FCWMLTAEQA_QRO_QA);
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "MTC-FT-018 Realizar reversa de compra por ACK negativo usando conector nuevo";
	}
	...
	public String setTestFullName() {
		...
		return "ATC_FT_018_PE2V2_RealizarReversaCompraPorACKNegativoConectorNuevo_test";
	}
