...
/**
*
* PE2V2:MTC-FT-057 Transaccion no exitosa  Provider - propiedad JSSE en el puerto desactivado
* Desc:
* Validar que el WS del consumer al tener una configuración diferente a la esperada 
* no permita realizar la transaccion
* 
...
* @date 02/27/2023
*/
public class ATC_FT_059_PE2V2_TransaccionNoExitosaProviderJSSEpuertoDesactivado extends BaseExecution{

	@Test (dataProvider = "data-provider")
	
	public void ATC_FT_059_PE2V2_TransaccionNoExitosaProviderJSSEpuertoDesactivado_test (HashMap<String, String> data) throws Exception {
		/*
		 * Utilerías
		 ************************************************************************/
...
//		utils.sql.SQLUtil dbFCWMLTAEQA_QRO = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_FCWMLTAEQA_QRO, GlobalVariables.DB_USER_FCWMLTAEQA_QA, GlobalVariables.DB_PASSWORD_FCWMLTAEQA_QRO_QA);
		...
		/******PREREQUISITOS******
		 * CP: MTC-FT-057 Transaccion no exitosa  Provider - propiedad JSSE en el puerto desactivado
		...
		******************************************Paso 2*************************************
		...
		/******************************************Paso 4*************************************/
		addStep("validar que la transacción se registro correctamente en la tabla TDC_TRANSACTION de la BD  **FCTDCQA**");
