...
public class ATC_FT_050_P2V2_TransacNoExitWSProSinPolitConfig extends BaseExecution {

	/**
	 * PE2V2:MTC-FT-050 Transaccion no exitosa  por WS Provider- sin politica configurada
	 * Desc:
	...
	public void ATC_FT_050_P2V2_TransacNoExitWSProSinPolitConfig_test(HashMap<String, String> data) throws Exception {
		...
		System.out.println("1. Ingresar al paquete del Switch sobre la ruta: FC_OXXO_SWITCH > FC > TPE >SWITCH > WS> WSSecurity\r\n"
		...
		Wm_Desc = getSimpleDataXml(responseRunGetFolio, "wmDesc");
		
		
		System.out.println("Folio: " + folio +" wmCode: " + Wm_code + " Wm Description: " + Wm_Desc);
	...
	public String setTestFullName() {
		return "ATC_FT_050_P2V2_TransacNoExitWSProSinPolitConfig_test";
	}
