...
/**
*
* PE2V2:MTC-FT-056 Transaccion no exitosa Consumer- Politica anterior
* Desc:
* Validar que el WS del Provider al tener  la politica anterior no permita realizar 
* la transaccion y lo marque por error de WsSecurity
* 
...
* @date 02/27/2023
*/
public class ATC_FT_056_PE2V2_TransaccionNoExitosaConsumerPoliticaAnterior extends BaseExecution{

	@Test (dataProvider = "data-provider")
	
	public void ATC_FT_056_PE2V2_TransaccionNoExitosaConsumerPoliticaAnterior_test (HashMap<String, String> data) throws Exception {
		/*
		 * Utilerías
		 ************************************************************************/
...
//		utils.sql.SQLUtil dbFCWMLTAEQA_QRO = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_FCWMLTAEQA_QRO, GlobalVariables.DB_USER_FCWMLTAEQA_QA, GlobalVariables.DB_PASSWORD_FCWMLTAEQA_QRO_QA);
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "MTC-FT-056 Transaccion no exitosa Consumer- Politica anterior";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_056_PE2V2_TransaccionNoExitosaConsumerPoliticaAnterior_test";
	}
