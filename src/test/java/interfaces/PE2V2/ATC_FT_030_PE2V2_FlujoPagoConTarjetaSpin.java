...
public class ATC_FT_030_PE2V2_FlujoPagoConTarjetaSpin extends BaseExecution{

	/**
	 * PE2V2:MTC-FT-030 CP041 Flujo de Pago Con Tarjeta Spin
	 * Desc:
	 * Regresion con XPOS
	 * Realizar un flujo exitoso de pago con Tarjeta Spin
	 * 
	 * Mtto:
	 * @author Jose Onofre
	 * @date 02/27/2023
	...
	public void ATC_FT_030_PE2V2_FlujoPagoConTarjetaSpin_test (HashMap<String, String> data) throws Exception {
		/*
		 * Utilerías
		 ************************************************************************/
...
//		utils.sql.SQLUtil dbFCWMLTAEQA_QRO = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_FCWMLTAEQA_QRO, GlobalVariables.DB_USER_FCWMLTAEQA_QA, GlobalVariables.DB_PASSWORD_FCWMLTAEQA_QRO_QA);
		...
		testCase.addBoldTextEvidenceCurrentStep("Se realiza correctamente la transaccion y se obtiene el folio");
	...
	public String setTestFullName() {
		...
		return "ATC_FT_030_PE2V2_FlujoPagoConTarjetaSpin_test";
	}
