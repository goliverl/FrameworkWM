 ...
 * CP: MTC-FT-010 PE3 Transacción exitosa de venta giftcar de artículo
...
public class ATC_FT_002_PE3_TransaccionExitosaVentaGratficarArticulo extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_002_PE3_TransaccionExitosaVentaGratficarArticulo_test(HashMap<String, String> data) throws Exception {
...
addStep("Ejecutar en un navegador directamente el servicio rungGetFolio  de solicitud de folio de la PE3");
		...
		//******************************** Paso 2 *******************************************************/
		addStep("Ejecutar en el navegador el servicio runGetAuth  para realizar la solicitud de activacion de la PE3 para tarjeta GifCard mediante la siguiente url: ");
		...
		//******************************** Paso 3 ******************************************************/
		addStep("Ejecutar el servicio  RunGetAck de la PE3  para confirmar el ACK de la transaccion venta de tarjeta GifCard , mediante la siguiente url de Ejemplo:");
