 ...
 * CP: MTC-FT-011 PE3 Transaccion exitosa de venta giftcard de servicio
...
public class ATC_FT_010_PE3_Venta_exitosa_giftcar_de_articulo extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_010_PE3_Venta_exitosa_giftcar_de_articulo_test(HashMap<String, String> data) throws Exception {

		/*
		 * Utilerias
		 *********************************************************************/
		SQLUtil dbTPE = new SQLUtil(GlobalVariables.DB_HOST_FCTPE,GlobalVariables.DB_USER_FCTPE, GlobalVariables.DB_PASSWORD_FCTPE);
		SQLUtil dbTPE_QRO = new SQLUtil(GlobalVariables.DB_HOST_FCTPE_QRO,GlobalVariables.DB_USER_FCTPE_QRO, GlobalVariables.DB_PASSWORD_FCTPE_QRO);
		
		System.out.println(data.get("host"));
		PE3 pe3Util = new PE3(data, testCase, dbTPE);
		...
		SQLResult resultQuery = dbTPE.executeQuery(query);
		...
		SQLResult resultQueryAuth = dbTPE.executeQuery(queryAuth);
		...
		SQLResult resultQueryAck = dbTPE.executeQuery(queryAck);
