...
public class ATC_FT_002_SW50_EnvioDocTipoPYR extends BaseExecution {

	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_002_SW50_EnvioDocTipoPYR_test(HashMap<String, String> data) throws Exception {
...
/** UTILERIA *********************************************************************/
	...
	//	utils.sql.SQLUtil dbEbs = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_EBS, GlobalVariables.DB_USER_EBS, GlobalVariables.DB_PASSWORD_EBS);
		...
		/**
		 * ALM
		 * Validar envio de documentos de tipo PYR a SAP en Oracle
		 */
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
		...
		/* PASO 2 *********************************************************************/
				...
				addStep("Validar que  la ejecuci�n de la interface concluye correctamente en la tabla WM_LOG_RUN y el thread es creado en WM_LOG_THREAD.\r\n"+ " \r\n...");
		...
		// Paso 4******************************
            ...
            addStep("Validar la insercion de los datos del header en la tabla SAP_PYR_HEADER.");
	     ...
	     /* PASO 5 ********************************************************/
              ...
              addStep("Validar la insercion de los datos de detalle en la tabla SAP_PYR_DETL.");
  ...
  public String setTestDescription() {
    return "Validar envio de documentos de tipo PYR a SAP en Oracle" ;
  }
