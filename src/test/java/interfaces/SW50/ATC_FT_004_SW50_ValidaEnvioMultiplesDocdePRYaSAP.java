...
public class ATC_FT_004_SW50_ValidaEnvioMultiplesDocdePRYaSAP extends BaseExecution {

	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_004_SW50_ValidaEnvioMultiplesDocdePRYaSAP_test(HashMap<String, String> data) throws Exception {
...
/** UTILERIA *********************************************************************/
		...
		/**
		 * ALM
		 * Validar envio de multiples documentos de tipo PRY a SAP
		 */
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
		...
		// Paso 4******************************
	     ...
	     /* PASO 5 ********************************************************/
              ...
              addStep("Validar la inserci�n de los datos de detalle en la tabla SAP_PYR_DETL.");
  ...
  public String setTestDescription() {
    return "Validar envio de múltiples documentos de tipo PRY a SAP" ;
  }
