...
public class OE11_MX_EnviarRelacionEdoFinyCR extends BaseExecution{
...
/** UTILERIA *********************************************************************/	
		...
		String tdcIntegrationServerFormat = "select * from (SELECT Tbl.run_id,interface, start_dt, end_dt, status, server "
				+ "FROM WMLOG.WM_LOG_RUN Tbl " + "WHERE INTERFACE LIKE '%OE11MX%' "
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "MTC-FT-057 Enviar confirmación facturas FI.";
	}
