...
public class OE11_MX_EnviarInfoEdoFinancieros extends BaseExecution{
...
/** UTILERIA *********************************************************************/	
		...
		String selectCampos = "SELECT WM_STATUS, WM_MENSAJE, WM_FECHA_ENVIO, WM_RUN_ID FROM "+ data.get("tabla");//retek_cr
		
		String selectCamposID = "SELECT WM_STATUS, WM_MENSAJE, WM_FECHA_ENVIO, WM_RUN_ID FROM "+ data.get("tabla") + " where " + data.get("identificador") +" = '%s'";
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
		...
		addStep("Validar que se tenga información de sociedades.");		
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Poder enviar los datos de compañías mediante la ejecución de una interfaz hacía Xpertal, la información será tomada de las tablas de paso de EBS.";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "MTC-FT-004 Enviar información de estados financieros";
	}
