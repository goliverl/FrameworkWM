...
public class OE11_MX_EnviarInfoCompania extends BaseExecution{
...
/** VARIABLES *********************************************************************/	
		...
		String selectCamposID = "SELECT ID_COMPANIA, WM_STATUS, WM_MENSAJE, WM_FECHA_ENVIO, WM_RUN_ID FROM "+ data.get("tabla") + " where " + data.get("identificador") +" = '%s'";
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "MTC-FT-003 Enviar Información de compañías";
	}
