...
public class ATC_FT_002_EO13_MX_RecibirAnticiposEBSExistente extends BaseExecution{
	@Test(dataProvider = "data-provider")
	public void ATC_FT_002_EO13_MX_RecibirAnticiposEBSExistente_test(HashMap<String, String> data) throws Exception {
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
	    ...
	    addStep("Validar en la tabla  WMLOG.WM_LOG_ERROR se genere errores");		
		...
		assertFalse(emptyError, "No se obtiene información de la consulta en la tabla WM_LOG_ERROR");
		

		/* PASO 6 *********************************************************************/
		
		addStep("Validar que se inserte el detalle de la ejecución de los Threads lanzados por la interface en la tabla WM_LOG_THREAD con STATUS = 'E'");		
		...
		assertFalse(validacion6, "No se obtiene información o Thread con STATUS diferente a 'E' de la consulta en la tabla WM_LOG_THREAD");
