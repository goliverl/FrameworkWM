...
public class EO13_PruebaVolumen extends BaseExecution {
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_003_EO13_PruebaVolumen(HashMap<String, String> data) throws Exception {
		/*
		...
		/**
		 * Cuentas por pagar
		 * MTC-FT-042 Recibir Anticipos Expertal-EBS Existente
		 */
		
		testCase.setProject_Name("I19040 Centralizacion Integral Cuentas por Pagar");
		 ...
		 * paso 3 
		 **************************************************************************************************************************/
		addStep("Ejecutar el siguiente query para validar que se tenga informaci�n de anticipo FI\r\n" + 
				"factura FI (proveedores Luz y Agua)\r\n" + 
				"factura FI (generales)\r\n" + 
				"Liberaci�n de Pasivos en Property ");
		...
		assertFalse("No se muestra informaci�n en los campos seleccionados por el query", validaregistrosStatusL);
...
//  Paso 7  *********************************
	...
	//Primera parte
		...
		if (!validaerror1) {
			...
			testCase.addBoldTextEvidenceCurrentStep("No se presentaron errores relacionados al performance de la interface en relaci�n con la carga");
		}
	...
	//Segunda parte
		...
		assertTrue("Se muestran errores relacionados al performance de la interface en relaci�n con la carga ", validaerror2);
...
//Paso 8 **************************************************************************
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. Validar prueba de volumen para la interfaz catalagos_GL con 2000 registros";
	}

	@Override
	public String setTestDesigner() {
		// TODO Auto-generated method stub
		return "Jos� Luis Flores Castellanos";
	}

	@Override
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_003_EO13_PruebaVolumen ";
	}
