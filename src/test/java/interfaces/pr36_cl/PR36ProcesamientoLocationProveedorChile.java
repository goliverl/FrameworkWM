...
public class PR36ProcesamientoLocationProveedorChile extends BaseExecution
{

	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_001_PR36_CL_PR36ProcesamientoLocationProveedorChile(HashMap<String, String> data) throws Exception {
...
/* Utilerías *********************************************************************/		
		...
		utils.sql.SQLUtil dbPosUserChi = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_PosUserChile,GlobalVariables.DB_USER_PosUserChile, GlobalVariables.DB_PASSWORD_PosUserChile);
...
*/		
		...
		String tdcAvailablePlaza = "select LOCATION, SUBSTR(store_name10,1,5) PLAZA from"
			      +" ( "
			              ...
			              +" FROM wmuser.repl_item_loc ril, item_loc_traits ilt, sups s"
...
//		SQLUtil.executeQuery(testCase, dbRms, tdcAvailablePlaza);
		...
		if (!av) {
			...
			testCase.addQueryEvidenceCurrentStep(AvaiblePlaza);
		}
 ...
 */
	...
	SQLResult PosPutBound = executeQuery(dbPosUserChi, tdcOutbound);

//	SQLUtil.executeQuery(testCase, dbPosUserChi, tdcOutbound);
	...
	public String setTestFullName() {
		...
		return "ATC_FT_001_PR36_CL_PR36ProcesamientoLocationProveedorChile";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Construido. PR36ProcesamientoLocationProveedorChile";
	}
