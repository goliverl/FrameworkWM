...
public class OE13_MX_EnviarRecepcionOrdenCompra extends BaseExecution{
...
/** UTILERIA *********************************************************************/	
		...
		//Primer select
		String select1_part1 = data.get("select");
		
		String select1_part2 = data.get("selectPart2");
		
		String select1_part3 = data.get("selectPart3");
		
		//Segundo select
		
		String select2_part1 = data.get("select2");
		
		String select2_part2 = data.get("select2Part2");
		
		String select3_part3 = data.get("select2Part3");
		...
		String tdcIntegrationServerFormat = "select * from (SELECT Tbl.run_id,interface, start_dt, end_dt, status, server "
				+ "FROM WMLOG.WM_LOG_RUN Tbl " + "WHERE INTERFACE LIKE '%OE13MX%' "
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
		...
		System.out.println(GlobalVariables.DB_HOST_AVEBQA);
		String selectFormat = String.format(select1_part1, data.get("variable1"));	
		String selectFormat2 = String.format(select1_part2, data.get("variable1"));	
		String selectFormat3 = String.format(select1_part3, data.get("variable1"));	
		
		System.out.println(selectFormat);	
		System.out.println(selectFormat2);
		System.out.println(selectFormat3);
		...
		addStep("Validar que se tenga información para procesar en la tabla " + data.get("tabla2"));		
		
		System.out.println(GlobalVariables.DB_HOST_AVEBQA);
		selectFormat = String.format(select2_part1, data.get("variable2"));	
		selectFormat2 = String.format(select2_part2, data.get("variable2"));
		selectFormat3 = String.format(select3_part3, data.get("variable2"));
		
		System.out.println(selectFormat);
		System.out.println(selectFormat2);
		System.out.println(selectFormat3);
		
		paso2 = executeQuery(dbAvebqa, selectFormat);		
		...
		System.out.println(av2);		
		assertFalse(av2, "No se obtiene información de la consulta en la tabla " + data.get("tabla2"));		  
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Poder enviarla información recepciones de órdenes de compra al almacén y las devoluciones al proveedor mediante la ejecución de una interfaz hacía Xpertal,la información será tomada de las tablas de paso de EBS.";
	}
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "MTC-FT-031 Enviar recepciones de órdenes de compra.";
	}
