...
public class PR25ProcemientoOrCompraCL extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_PR25_002_Procemiento_Or_Compra_CL(HashMap<String, String> data) throws Exception {
...
/** VARIABLES *********************************************************************/	
		...
		String tdcQueryOrder2 = " SELECT a.load_batch_id,a.order_number,a.wm_status,location \r\n"  
				...
				+ " AND  b.external_order_num IS NULL \r\n"
				+ " AND a.wm_status = 'L' \r\n"
		...
		String retekE = "SELECT load_batch_id,order_number,wm_status FROM WMUSER.ordenes_control \r\n"
				+ " WHERE wm_status = 'E' \r\n"  
				+ " AND wm_run_id = '%s'  \r\n"
				+ " AND location = '%s' \r\n" 
				+ " AND order_number = '%s' \r\n";
...
/** PASOS DEL CASO DE PRUEBA *********************************************************************/	
		...
		addStep("Ejecutar la interfaz PR25_CL");
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_PR25_002_Procemiento_Or_Compra_CL";
	}
