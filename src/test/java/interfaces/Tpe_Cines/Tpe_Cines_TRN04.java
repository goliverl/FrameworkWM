...
public class Tpe_Cines_TRN04 extends BaseExecution  {
	
@Test(dataProvider = "data-provider")
	
	public void ATC_FT_Tpe_007_Cines_TRN04 (HashMap<String, String> data) throws Exception {
...
/* Variables *********************************************************************/
	...
	String respuestaTrn04 = TPECinesUTIL.TRN04();

	System.out.println("Respuesta: " + respuestaTrn04);

	String wmcodigo = RequestUtil.getWmCodeXml(respuestaTrn04);
	...
	boolean validationRequest = wmCodeTRN04.equals(wmcodigo);
...
public String setTestDescription() {
	// TODO Auto-generated method stub
	return "Construccion.Tpe_Cines TRN04";
}
...
public String setTestFullName() {
	// TODO Auto-generated method stub
	return "ATC_FT_Tpe_007_Cines_TRN04";
}
