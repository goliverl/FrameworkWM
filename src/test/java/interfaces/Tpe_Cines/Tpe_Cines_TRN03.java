...
public class Tpe_Cines_TRN03 extends BaseExecution  {
	
@Test(dataProvider = "data-provider")
	
	public void ATC_FT_Tpe_006_Cines_TRN03(HashMap<String, String> data) throws Exception {
...
/* Variables *********************************************************************/
	...
	String respuestaTrn03 = TPECinesUTIL.TRN03();

	System.out.println("Respuesta: " + respuestaTrn03);

	String wmcodigo = RequestUtil.getWmCodeXml(respuestaTrn03);
	...
	boolean validationRequest = wmCodeTRN03.equals(wmcodigo);
...
public String setTestDescription() {
	// TODO Auto-generated method stub
	return "Contruccion.Tpe_Cines TRN03";
}
...
public String setTestFullName() {
	// TODO Auto-generated method stub
	return "ATC_FT_Tpe_006_Cines_TRN03";
}
