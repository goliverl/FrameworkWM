...
public class RO4_MEX_Facturas_ModoAuto extends BaseExecution {

	@Test(dataProvider = "data-provider")
	public void ATC_FT_RO4_001_MEX_Facturas_ModoAuto(HashMap<String, String> data) throws Exception {
		...
		String pendiente_rechead_temp_temp_1 = "select * from (SELECT SHIPMENT,ORDER_NO,SUPPLIER_ID,RECEIVE_DATE,TERMS_DESC"
				...
				+ "') order by receive_date desc) where rownum <=3";// RMS
		...
		String verifConfig = "SELECT * FROM WMUSER.wm_cfg_launcher WHERE interface_name = "
				+ "'RO4' AND auto_status = 'A' AND attribute1 = '" + data.get("plaza") + "'";// posUser
...
//					Paso 3	************************	
		...
		assertFalse("No se muestran registros que cumplan con el rango de fechas de ejecucion en fem_rtvhead_temp",
				paso3);
		// Paso 4 ************************
		addStep("Ejecutar  el servicio de la interfaz RO4_MEX");
		// utileria
...
//		********************		Paso 8	************************	
	...
	public String setTestFullName() {
		...
		return "ATC_FT_RO4_001_MEX_Facturas_ModoAuto";
	}

	@Override
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Ejecucion de la interfaz para el procesamiento de las Facturas";
	}
