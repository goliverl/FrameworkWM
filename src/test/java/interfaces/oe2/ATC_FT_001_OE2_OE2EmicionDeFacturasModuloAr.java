...
public class ATC_FT_001_OE2_OE2EmicionDeFacturasModuloAr extends BaseExecution{
		
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_001_OE2_OE2EmicionDeFacturasModuloAr_test(HashMap<String, String> data) throws Exception {
...
addStep("Actualizar el estado las facturas generadas en el módulo AR para la plaza 10MON en la tabla XXFC_CFD_FACTURA_DIGITAL de Oracle a WM_STATUS = 'L'",
		"Se actualiza el estado de las facturas AR a procesar a WM_STATUS = 'L' y el campo DOCTO_XML = NULL.");		
		
		System.out.println(GlobalVariables.DB_HOST_AVEBQA);
		System.out.println(TdcQueryEstadoFacturas);
		System.out.println(data.get("Factura"));
...
addStep("Validar la actualización del estatus (WM_STATUS = 'E'), el XML de la factura en el campo DOCTO_XML y los campos referentes a la factura digital en la tabla XXFC_CFD_FACTURA_DIGITAL de Oracle.", 
	...
	System.out.println(GetTdcQueryFacturasEmitidas);
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_001_OE2_OE2EmicionDeFacturasModuloAr_test";
	}
