...
public class ATC_FT_001_OE2_OE2EmicionDeFacturasModuloGlobalMensual extends BaseExecution{
	
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_001_OE2_OE2EmicionDeFacturasModuloGlobalMensual_test(HashMap<String, String> data) throws Exception {
...
addStep("Validar la actualización del estatus (WM_STATUS = 'E'), el XML de la factura en el campo DOCTO_XML y los campos referentes a la factura digital en la tabla XXFC_CFD_FACTURA_DIGITAL de Oracle.", 
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_001_OE2_OE2EmicionDeFacturasModuloGlobalMensual_test";
	}
