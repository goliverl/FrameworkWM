...
public class PE6DepositoServiciosElctronicos extends BaseExecution {
	...
	public void ATC_FT_005_PE6_Deposito_Servicios_Electronicos(HashMap<String, String> data) throws Exception {
		utils.sql.SQLUtil dbFCTDCQA = new utils.sql.SQLUtil(GlobalVariables.DB_HOST_FCTDCQA,
				GlobalVariables.DB_USER_FCTDCQA, DB_PASSWORD_FCTDCQA);
...
//		testCase.setPrerequisites(data.get("pre"));
		...
		addStep("Solicitar autorización del " + tarjeta + " desde un navegador, invocando el servicio runGetAuth:");
		...
		addStep("Solicitar confirmación de ACK del " + tarjeta
				+ " desde un navegador, invocando el servicio runGetAuth: ");
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Terminado. Validar que transacciones con tarjeta se registren correctamente";
	}
	@Override
	...
	public String setTestFullName() {
		return "ATC_FT_005_PE6_Deposito_Servicios_Electronicos";
	}
	@Override
