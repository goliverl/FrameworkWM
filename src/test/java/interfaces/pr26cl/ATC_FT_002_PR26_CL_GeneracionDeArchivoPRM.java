 ...
 * para generar archivos PRM de bajada (de RMS a WM OUTBOUND) con la información actualizada o 
 * nueva de articulos, al ser migrada la interface de WM9.9 a WM10.5
 * 
 * 
 * @reviewer Gilberto Martinez
 * @date 2023/22/02
 */
public class ATC_FT_002_PR26_CL_GeneracionDeArchivoPRM extends BaseExecution{

	@Test(dataProvider = "data-provider")
	public void ATC_FT_002_PR26_CL_GeneracionDeArchivoPRM_test(HashMap<String, String> data) throws Exception {
...
//paso 7 ****************************
	...
	public String setTestFullName() {
		// TODO Auto-generated method stub
		return "ATC_FT_002_PR26_CL_GeneracionDeArchivoPRM_test";
	}
