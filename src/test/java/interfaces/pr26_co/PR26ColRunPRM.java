...
public class PR26ColRunPRM extends BaseExecution {
	...
	public void ATC_FT_002_pr26_co_PR26ColRunPRM(HashMap<String, String> data) throws Exception {
		...
		/*
		 * paso 2Validar que hay información pendiente de procesar en la tabla:
		...
		/*
		 * paso 3Validar información de PRM (Promociones) en las tablas:
		 * FEM_POS_MODS_STG_COL y PROMHEAD. .
		 **********************/
		addStep("Validar información de PRM (Promociones) en las tablas: FEM_POS_MODS_STG_COL y PROMHEAD.");
	...
	//Parte 2
		...
		assertFalse("No existe información de promociones en las tablas de RETEK", paso33);
		...
		assertFalse("No xiste información de detalle de promociones ", paso42);
...
//********************************Paso 8*********************************************************
		addStep("Validar que el archivo XML se depositó correctamente en el buzón de la tienda ");
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Terminada. Validar el envío de información PRM ";
	}
