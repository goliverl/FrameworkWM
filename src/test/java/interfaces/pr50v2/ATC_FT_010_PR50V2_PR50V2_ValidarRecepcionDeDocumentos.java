...
public class ATC_FT_010_PR50V2_PR50V2_ValidarRecepcionDeDocumentos extends BaseExecution{
	
	@Test(dataProvider = "data-provider")
	public void ATC_FT_010_PR50V2_PR50V2_ValidarRecepcionDeDocumentos_test(HashMap<String, String> data) throws Exception {
...
/** UTILERIA *********************************************************************/	
       ...
       /**
        * ALM
        * Validar recepcion de documentos tipo ADJ (Inbound)
        */
...
//		Copiar el archivo del tipo de documento ADJ en formato plano a la ruta C:\ENV del POS. 
//		Validar la ejecucion del servicio wm.tn.receive por FTP en los logs de la DS50:
//
//			ftp://10.182.92.13:7787/%2F/ns/wm/tn/receive/
...
//PAso 3 ************************************************************************************************************************************					
	...
	public String setTestDescription() {
		// TODO Auto-generated method stub
		return "Validar recepción de documentos (Inbound)";
	}
