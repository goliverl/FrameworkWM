...
public class AdaptersOneButton  extends BaseExecution {
	...
	public void test(HashMap<String, String> data) throws Exception {
		...
		testCase.setProject_Name("Autonomia Sistema OXXO Colombia");
	    ...
	    addStep("Validar que el registro de ejecucion de la interfaz termino en estatus 'E' en la tabla WM_LOG_RUN.");
